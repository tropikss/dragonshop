...
.nes-sex {
  position: absolute;
  animation: sex 1.5s infinite;
  -webkit-animation: sex 1.5s infinite;
  -moz-animation: sex 1.5s infinite;
  -o-animation: sex 1.5s infinite;
  transform : scale(7);
}
...
@keyframes sex {
0%, 20%{
  box-shadow: 2px 3px 0 0 rgba(255, 152, 0, 1), 3px 3px 0 0 rgba(255, 193, 7, 1), 4px 3px 0 0 rgba(255, 193, 7, 1), 5px 3px 0 0 rgba(255, 152, 0, 1), 13px 3px 0 0 rgba(121, 85, 72, 1), 14px 3px 0 0 rgba(121, 85, 72, 1), 1px 4px 0 0 rgba(255, 152, 0, 1), 2px 4px 0 0 rgba(255, 152, 0, 1), 3px 4px 0 0 rgba(255, 152, 0, 1), 4px 4px 0 0 rgba(255, 152, 0, 1), 5px 4px 0 0 rgba(255, 152, 0, 1), 6px 4px 0 0 rgba(255, 152, 0, 1), 12px 4px 0 0 rgba(121, 85, 72, 1), 13px 4px 0 0 rgba(121, 85, 72, 1), 14px 4px 0 0 rgba(121, 85, 72, 1), 15px 4px 0 0 rgba(121, 85, 72, 1), 16px 4px 0 0 rgba(121, 85, 72, 1), 1px 5px 0 0 rgba(255, 152, 0, 1), 2px 5px 0 0 rgba(255, 193, 7, 1), 3px 5px 0 0 rgba(255, 193, 7, 1), 4px 5px 0 0 rgba(255, 193, 7, 1), 5px 5px 0 0 rgba(255, 193, 7, 1), 6px 5px 0 0 rgba(255, 205, 210, 1), 12px 5px 0 0 rgba(255, 205, 210, 1), 13px 5px 0 0 rgba(121, 85, 72, 1), 14px 5px 0 0 rgba(121, 85, 72, 1), 15px 5px 0 0 rgba(121, 85, 72, 1), 16px 5px 0 0 rgba(121, 85, 72, 1), 1px 6px 0 0 rgba(255, 193, 7, 1), 2px 6px 0 0 rgba(255, 205, 210, 1), 3px 6px 0 0 rgba(255, 205, 210, 1), 4px 6px 0 0 rgba(255, 193, 7, 1), 5px 6px 0 0 rgba(255, 205, 210, 1), 6px 6px 0 0 rgba(255, 205, 210, 1), 11px 6px 0 0 rgba(255, 205, 210, 1), 12px 6px 0 0 rgba(255, 205, 210, 1), 13px 6px 0 0 rgba(255, 205, 210, 1), 14px 6px 0 0 rgba(121, 85, 72, 1), 15px 6px 0 0 rgba(121, 85, 72, 1), 16px 6px 0 0 rgba(121, 85, 72, 1), 1px 7px 0 0 rgba(255, 152, 0, 1), 2px 7px 0 0 rgba(255, 205, 210, 1), 3px 7px 0 0 rgba(255, 205, 210, 1), 4px 7px 0 0 rgba(255, 205, 210, 1), 5px 7px 0 0 rgba(76, 175, 80, 1), 6px 7px 0 0 rgba(255, 205, 210, 1), 11px 7px 0 0 rgba(255, 205, 210, 1), 12px 7px 0 0 rgba(121, 85, 72, 1), 13px 7px 0 0 rgba(255, 205, 210, 1), 14px 7px 0 0 rgba(255, 205, 210, 1), 15px 7px 0 0 rgba(121, 85, 72, 1), 16px 7px 0 0 rgba(121, 85, 72, 1), 1px 8px 0 0 rgba(255, 205, 210, 1), 2px 8px 0 0 rgba(255, 205, 210, 1), 3px 8px 0 0 rgba(255, 205, 210, 1), 4px 8px 0 0 rgba(255, 205, 210, 1), 5px 8px 0 0 rgba(255, 205, 210, 1), 6px 8px 0 0 rgba(255, 205, 210, 1), 7px 8px 0 0 rgba(255, 205, 210, 1), 10px 8px 0 0 rgba(255, 205, 210, 1), 11px 8px 0 0 rgba(255, 205, 210, 1), 12px 8px 0 0 rgba(255, 205, 210, 1), 13px 8px 0 0 rgba(255, 205, 210, 1), 14px 8px 0 0 rgba(255, 205, 210, 1), 15px 8px 0 0 rgba(121, 85, 72, 1), 16px 8px 0 0 rgba(121, 85, 72, 1), 1px 9px 0 0 rgba(255, 205, 210, 1), 2px 9px 0 0 rgba(255, 205, 210, 1), 3px 9px 0 0 rgba(255, 205, 210, 1), 4px 9px 0 0 rgba(255, 205, 210, 1), 5px 9px 0 0 rgba(255, 205, 210, 1), 6px 9px 0 0 rgba(255, 87, 34, 1), 11px 9px 0 0 rgba(255, 87, 34, 1), 12px 9px 0 0 rgba(255, 205, 210, 1), 13px 9px 0 0 rgba(255, 205, 210, 1), 14px 9px 0 0 rgba(255, 205, 210, 1), 15px 9px 0 0 rgba(121, 85, 72, 1), 16px 9px 0 0 rgba(121, 85, 72, 1), 2px 10px 0 0 rgba(255, 205, 210, 1), 3px 10px 0 0 rgba(255, 205, 210, 1), 4px 10px 0 0 rgba(255, 205, 210, 1), 5px 10px 0 0 rgba(255, 205, 210, 1), 6px 10px 0 0 rgba(255, 205, 210, 1), 11px 10px 0 0 rgba(255, 205, 210, 1), 12px 10px 0 0 rgba(255, 205, 210, 1), 13px 10px 0 0 rgba(255, 205, 210, 1), 14px 10px 0 0 rgba(255, 205, 210, 1), 15px 10px 0 0 rgba(121, 85, 72, 1), 16px 10px 0 0 rgba(121, 85, 72, 1), 3px 11px 0 0 rgba(255, 205, 210, 1), 4px 11px 0 0 rgba(255, 205, 210, 1), 13px 11px 0 0 rgba(255, 205, 210, 1), 14px 11px 0 0 rgba(255, 205, 210, 1), 15px 11px 0 0 rgba(121, 85, 72, 1), 16px 11px 0 0 rgba(121, 85, 72, 1), 3px 12px 0 0 rgba(255, 205, 210, 1), 4px 12px 0 0 rgba(255, 205, 210, 1), 13px 12px 0 0 rgba(255, 205, 210, 1), 14px 12px 0 0 rgba(255, 205, 210, 1), 15px 12px 0 0 rgba(121, 85, 72, 1), 16px 12px 0 0 rgba(121, 85, 72, 1);height: 1px; width: 1px;
  }
20.01%, 40%{
  box-shadow: 3px 3px 0 0 rgba(255, 193, 7, 1), 4px 3px 0 0 rgba(255, 193, 7, 1), 5px 3px 0 0 rgba(255, 152, 0, 1), 12px 3px 0 0 rgba(121, 85, 72, 1), 13px 3px 0 0 rgba(121, 85, 72, 1), 14px 3px 0 0 rgba(121, 85, 72, 1), 2px 4px 0 0 rgba(255, 152, 0, 1), 3px 4px 0 0 rgba(255, 152, 0, 1), 4px 4px 0 0 rgba(255, 152, 0, 1), 5px 4px 0 0 rgba(255, 152, 0, 1), 6px 4px 0 0 rgba(255, 152, 0, 1), 11px 4px 0 0 rgba(121, 85, 72, 1), 12px 4px 0 0 rgba(121, 85, 72, 1), 13px 4px 0 0 rgba(121, 85, 72, 1), 14px 4px 0 0 rgba(121, 85, 72, 1), 15px 4px 0 0 rgba(121, 85, 72, 1), 1px 5px 0 0 rgba(255, 152, 0, 1), 2px 5px 0 0 rgba(255, 193, 7, 1), 3px 5px 0 0 rgba(255, 193, 7, 1), 4px 5px 0 0 rgba(255, 193, 7, 1), 5px 5px 0 0 rgba(255, 193, 7, 1), 6px 5px 0 0 rgba(255, 193, 7, 1), 7px 5px 0 0 rgba(255, 152, 0, 1), 11px 5px 0 0 rgba(255, 205, 210, 1), 12px 5px 0 0 rgba(121, 85, 72, 1), 13px 5px 0 0 rgba(121, 85, 72, 1), 14px 5px 0 0 rgba(121, 85, 72, 1), 15px 5px 0 0 rgba(121, 85, 72, 1), 16px 5px 0 0 rgba(121, 85, 72, 1), 1px 6px 0 0 rgba(255, 193, 7, 1), 2px 6px 0 0 rgba(255, 152, 0, 1), 3px 6px 0 0 rgba(255, 152, 0, 1), 4px 6px 0 0 rgba(255, 193, 7, 1), 5px 6px 0 0 rgba(255, 152, 0, 1), 6px 6px 0 0 rgba(255, 205, 210, 1), 7px 6px 0 0 rgba(255, 205, 210, 1), 10px 6px 0 0 rgba(255, 205, 210, 1), 11px 6px 0 0 rgba(255, 205, 210, 1), 12px 6px 0 0 rgba(255, 205, 210, 1), 13px 6px 0 0 rgba(121, 85, 72, 1), 14px 6px 0 0 rgba(121, 85, 72, 1), 15px 6px 0 0 rgba(121, 85, 72, 1), 16px 6px 0 0 rgba(121, 85, 72, 1), 1px 7px 0 0 rgba(255, 152, 0, 1), 2px 7px 0 0 rgba(255, 205, 210, 1), 3px 7px 0 0 rgba(255, 205, 210, 1), 4px 7px 0 0 rgba(255, 205, 210, 1), 5px 7px 0 0 rgba(255, 205, 210, 1), 6px 7px 0 0 rgba(76, 175, 80, 1), 7px 7px 0 0 rgba(255, 205, 210, 1), 10px 7px 0 0 rgba(255, 205, 210, 1), 11px 7px 0 0 rgba(121, 85, 72, 1), 12px 7px 0 0 rgba(255, 205, 210, 1), 13px 7px 0 0 rgba(255, 205, 210, 1), 14px 7px 0 0 rgba(121, 85, 72, 1), 15px 7px 0 0 rgba(121, 85, 72, 1), 16px 7px 0 0 rgba(121, 85, 72, 1), 1px 8px 0 0 rgba(255, 205, 210, 1), 2px 8px 0 0 rgba(255, 205, 210, 1), 3px 8px 0 0 rgba(255, 205, 210, 1), 4px 8px 0 0 rgba(255, 205, 210, 1), 5px 8px 0 0 rgba(255, 205, 210, 1), 6px 8px 0 0 rgba(255, 205, 210, 1), 7px 8px 0 0 rgba(255, 205, 210, 1), 8px 8px 0 0 rgba(255, 205, 210, 1), 9px 8px 0 0 rgba(255, 205, 210, 1), 10px 8px 0 0 rgba(255, 205, 210, 1), 11px 8px 0 0 rgba(255, 205, 210, 1), 12px 8px 0 0 rgba(255, 205, 210, 1), 13px 8px 0 0 rgba(255, 205, 210, 1), 14px 8px 0 0 rgba(255, 205, 210, 1), 15px 8px 0 0 rgba(121, 85, 72, 1), 16px 8px 0 0 rgba(121, 85, 72, 1), 2px 9px 0 0 rgba(255, 205, 210, 1), 3px 9px 0 0 rgba(255, 205, 210, 1), 4px 9px 0 0 rgba(255, 205, 210, 1), 5px 9px 0 0 rgba(255, 205, 210, 1), 6px 9px 0 0 rgba(255, 205, 210, 1), 7px 9px 0 0 rgba(255, 87, 34, 1), 10px 9px 0 0 rgba(255, 87, 34, 1), 11px 9px 0 0 rgba(255, 205, 210, 1), 12px 9px 0 0 rgba(255, 205, 210, 1), 13px 9px 0 0 rgba(255, 205, 210, 1), 14px 9px 0 0 rgba(255, 205, 210, 1), 15px 9px 0 0 rgba(121, 85, 72, 1), 16px 9px 0 0 rgba(121, 85, 72, 1), 3px 10px 0 0 rgba(255, 205, 210, 1), 4px 10px 0 0 rgba(255, 205, 210, 1), 5px 10px 0 0 rgba(255, 205, 210, 1), 6px 10px 0 0 rgba(255, 205, 210, 1), 7px 10px 0 0 rgba(255, 205, 210, 1), 10px 10px 0 0 rgba(255, 205, 210, 1), 11px 10px 0 0 rgba(255, 205, 210, 1), 12px 10px 0 0 rgba(255, 205, 210, 1), 13px 10px 0 0 rgba(255, 205, 210, 1), 14px 10px 0 0 rgba(255, 205, 210, 1), 15px 10px 0 0 rgba(121, 85, 72, 1), 16px 10px 0 0 rgba(121, 85, 72, 1), 3px 11px 0 0 rgba(255, 205, 210, 1), 4px 11px 0 0 rgba(255, 205, 210, 1), 13px 11px 0 0 rgba(255, 205, 210, 1), 14px 11px 0 0 rgba(255, 205, 210, 1), 15px 11px 0 0 rgba(121, 85, 72, 1), 16px 11px 0 0 rgba(121, 85, 72, 1), 3px 12px 0 0 rgba(255, 205, 210, 1), 4px 12px 0 0 rgba(255, 205, 210, 1), 13px 12px 0 0 rgba(255, 205, 210, 1), 14px 12px 0 0 rgba(255, 205, 210, 1), 15px 12px 0 0 rgba(121, 85, 72, 1), 16px 12px 0 0 rgba(121, 85, 72, 1);height: 1px; width: 1px;
  }
40.01%, 60%{
  box-shadow: 4px 3px 0 0 rgba(255, 193, 7, 1), 5px 3px 0 0 rgba(255, 193, 7, 1), 6px 3px 0 0 rgba(255, 193, 7, 1), 12px 3px 0 0 rgba(121, 85, 72, 1), 13px 3px 0 0 rgba(121, 85, 72, 1), 14px 3px 0 0 rgba(121, 85, 72, 1), 3px 4px 0 0 rgba(255, 152, 0, 1), 4px 4px 0 0 rgba(255, 152, 0, 1), 5px 4px 0 0 rgba(255, 152, 0, 1), 6px 4px 0 0 rgba(255, 152, 0, 1), 7px 4px 0 0 rgba(255, 193, 7, 1), 11px 4px 0 0 rgba(121, 85, 72, 1), 12px 4px 0 0 rgba(121, 85, 72, 1), 13px 4px 0 0 rgba(121, 85, 72, 1), 14px 4px 0 0 rgba(121, 85, 72, 1), 15px 4px 0 0 rgba(121, 85, 72, 1), 2px 5px 0 0 rgba(255, 193, 7, 1), 3px 5px 0 0 rgba(255, 193, 7, 1), 4px 5px 0 0 rgba(255, 193, 7, 1), 5px 5px 0 0 rgba(255, 193, 7, 1), 6px 5px 0 0 rgba(255, 193, 7, 1), 7px 5px 0 0 rgba(255, 152, 0, 1), 8px 5px 0 0 rgba(255, 193, 7, 1), 11px 5px 0 0 rgba(255, 205, 210, 1), 12px 5px 0 0 rgba(121, 85, 72, 1), 13px 5px 0 0 rgba(121, 85, 72, 1), 14px 5px 0 0 rgba(121, 85, 72, 1), 15px 5px 0 0 rgba(121, 85, 72, 1), 16px 5px 0 0 rgba(121, 85, 72, 1), 2px 6px 0 0 rgba(255, 152, 0, 1), 3px 6px 0 0 rgba(255, 152, 0, 1), 4px 6px 0 0 rgba(255, 193, 7, 1), 5px 6px 0 0 rgba(255, 152, 0, 1), 6px 6px 0 0 rgba(255, 205, 210, 1), 7px 6px 0 0 rgba(255, 205, 210, 1), 8px 6px 0 0 rgba(255, 205, 210, 1), 10px 6px 0 0 rgba(255, 205, 210, 1), 11px 6px 0 0 rgba(255, 205, 210, 1), 12px 6px 0 0 rgba(255, 205, 210, 1), 13px 6px 0 0 rgba(121, 85, 72, 1), 14px 6px 0 0 rgba(121, 85, 72, 1), 15px 6px 0 0 rgba(121, 85, 72, 1), 16px 6px 0 0 rgba(121, 85, 72, 1), 2px 7px 0 0 rgba(255, 152, 0, 1), 3px 7px 0 0 rgba(255, 152, 0, 1), 4px 7px 0 0 rgba(255, 205, 210, 1), 5px 7px 0 0 rgba(255, 205, 210, 1), 6px 7px 0 0 rgba(255, 205, 210, 1), 7px 7px 0 0 rgba(255, 205, 210, 1), 8px 7px 0 0 rgba(76, 175, 80, 1), 10px 7px 0 0 rgba(255, 205, 210, 1), 11px 7px 0 0 rgba(121, 85, 72, 1), 12px 7px 0 0 rgba(255, 205, 210, 1), 13px 7px 0 0 rgba(255, 205, 210, 1), 14px 7px 0 0 rgba(121, 85, 72, 1), 15px 7px 0 0 rgba(121, 85, 72, 1), 16px 7px 0 0 rgba(121, 85, 72, 1), 2px 8px 0 0 rgba(255, 152, 0, 1), 3px 8px 0 0 rgba(255, 205, 210, 1), 4px 8px 0 0 rgba(255, 205, 210, 1), 5px 8px 0 0 rgba(255, 205, 210, 1), 6px 8px 0 0 rgba(255, 205, 210, 1), 7px 8px 0 0 rgba(255, 205, 210, 1), 8px 8px 0 0 rgba(255, 205, 210, 1), 9px 8px 0 0 rgba(255, 205, 210, 1), 10px 8px 0 0 rgba(255, 205, 210, 1), 11px 8px 0 0 rgba(255, 205, 210, 1), 12px 8px 0 0 rgba(255, 205, 210, 1), 13px 8px 0 0 rgba(255, 205, 210, 1), 14px 8px 0 0 rgba(255, 205, 210, 1), 15px 8px 0 0 rgba(121, 85, 72, 1), 16px 8px 0 0 rgba(121, 85, 72, 1), 2px 9px 0 0 rgba(255, 205, 210, 1), 3px 9px 0 0 rgba(255, 205, 210, 1), 4px 9px 0 0 rgba(255, 205, 210, 1), 5px 9px 0 0 rgba(255, 205, 210, 1), 6px 9px 0 0 rgba(255, 205, 210, 1), 7px 9px 0 0 rgba(255, 205, 210, 1), 8px 9px 0 0 rgba(255, 87, 34, 1), 10px 9px 0 0 rgba(255, 87, 34, 1), 11px 9px 0 0 rgba(255, 205, 210, 1), 12px 9px 0 0 rgba(255, 205, 210, 1), 13px 9px 0 0 rgba(255, 205, 210, 1), 14px 9px 0 0 rgba(255, 205, 210, 1), 15px 9px 0 0 rgba(121, 85, 72, 1), 16px 9px 0 0 rgba(121, 85, 72, 1), 3px 10px 0 0 rgba(255, 205, 210, 1), 4px 10px 0 0 rgba(255, 205, 210, 1), 5px 10px 0 0 rgba(255, 205, 210, 1), 6px 10px 0 0 rgba(255, 205, 210, 1), 7px 10px 0 0 rgba(255, 205, 210, 1), 8px 10px 0 0 rgba(255, 205, 210, 1), 10px 10px 0 0 rgba(255, 205, 210, 1), 11px 10px 0 0 rgba(255, 205, 210, 1), 12px 10px 0 0 rgba(255, 205, 210, 1), 13px 10px 0 0 rgba(255, 205, 210, 1), 14px 10px 0 0 rgba(255, 205, 210, 1), 15px 10px 0 0 rgba(121, 85, 72, 1), 16px 10px 0 0 rgba(121, 85, 72, 1), 4px 11px 0 0 rgba(255, 205, 210, 1), 5px 11px 0 0 rgba(255, 205, 210, 1), 13px 11px 0 0 rgba(255, 205, 210, 1), 14px 11px 0 0 rgba(255, 205, 210, 1), 15px 11px 0 0 rgba(121, 85, 72, 1), 16px 11px 0 0 rgba(121, 85, 72, 1), 4px 12px 0 0 rgba(255, 205, 210, 1), 5px 12px 0 0 rgba(255, 205, 210, 1), 13px 12px 0 0 rgba(255, 205, 210, 1), 14px 12px 0 0 rgba(255, 205, 210, 1), 15px 12px 0 0 rgba(121, 85, 72, 1), 16px 12px 0 0 rgba(121, 85, 72, 1);height: 1px; width: 1px;
  }
60.01%, 80%{
  box-shadow: 4px 3px 0 0 rgba(255, 193, 7, 1), 5px 3px 0 0 rgba(255, 193, 7, 1), 6px 3px 0 0 rgba(255, 193, 7, 1), 12px 3px 0 0 rgba(121, 85, 72, 1), 13px 3px 0 0 rgba(121, 85, 72, 1), 14px 3px 0 0 rgba(121, 85, 72, 1), 3px 4px 0 0 rgba(255, 152, 0, 1), 4px 4px 0 0 rgba(255, 152, 0, 1), 5px 4px 0 0 rgba(255, 152, 0, 1), 6px 4px 0 0 rgba(255, 152, 0, 1), 7px 4px 0 0 rgba(255, 193, 7, 1), 11px 4px 0 0 rgba(121, 85, 72, 1), 12px 4px 0 0 rgba(121, 85, 72, 1), 13px 4px 0 0 rgba(121, 85, 72, 1), 14px 4px 0 0 rgba(121, 85, 72, 1), 15px 4px 0 0 rgba(121, 85, 72, 1), 2px 5px 0 0 rgba(255, 193, 7, 1), 3px 5px 0 0 rgba(255, 193, 7, 1), 4px 5px 0 0 rgba(255, 193, 7, 1), 5px 5px 0 0 rgba(255, 193, 7, 1), 6px 5px 0 0 rgba(255, 193, 7, 1), 7px 5px 0 0 rgba(255, 152, 0, 1), 8px 5px 0 0 rgba(255, 193, 7, 1), 10px 5px 0 0 rgba(255, 205, 210, 1), 11px 5px 0 0 rgba(255, 205, 210, 1), 12px 5px 0 0 rgba(121, 85, 72, 1), 13px 5px 0 0 rgba(121, 85, 72, 1), 14px 5px 0 0 rgba(121, 85, 72, 1), 15px 5px 0 0 rgba(121, 85, 72, 1), 16px 5px 0 0 rgba(121, 85, 72, 1), 2px 6px 0 0 rgba(255, 152, 0, 1), 3px 6px 0 0 rgba(255, 152, 0, 1), 4px 6px 0 0 rgba(255, 193, 7, 1), 5px 6px 0 0 rgba(255, 152, 0, 1), 6px 6px 0 0 rgba(255, 205, 210, 1), 7px 6px 0 0 rgba(255, 205, 210, 1), 8px 6px 0 0 rgba(255, 205, 210, 1), 9px 6px 0 0 rgba(255, 205, 210, 1), 10px 6px 0 0 rgba(255, 205, 210, 1), 11px 6px 0 0 rgba(255, 205, 210, 1), 12px 6px 0 0 rgba(255, 205, 210, 1), 13px 6px 0 0 rgba(121, 85, 72, 1), 14px 6px 0 0 rgba(121, 85, 72, 1), 15px 6px 0 0 rgba(121, 85, 72, 1), 16px 6px 0 0 rgba(121, 85, 72, 1), 2px 7px 0 0 rgba(255, 152, 0, 1), 3px 7px 0 0 rgba(255, 152, 0, 1), 4px 7px 0 0 rgba(255, 205, 210, 1), 5px 7px 0 0 rgba(255, 205, 210, 1), 6px 7px 0 0 rgba(255, 205, 210, 1), 7px 7px 0 0 rgba(255, 205, 210, 1), 8px 7px 0 0 rgba(76, 175, 80, 1), 9px 7px 0 0 rgba(121, 85, 72, 1), 10px 7px 0 0 rgba(255, 205, 210, 1), 11px 7px 0 0 rgba(255, 205, 210, 1), 12px 7px 0 0 rgba(255, 205, 210, 1), 13px 7px 0 0 rgba(255, 205, 210, 1), 14px 7px 0 0 rgba(121, 85, 72, 1), 15px 7px 0 0 rgba(121, 85, 72, 1), 16px 7px 0 0 rgba(121, 85, 72, 1), 2px 8px 0 0 rgba(255, 152, 0, 1), 3px 8px 0 0 rgba(255, 205, 210, 1), 4px 8px 0 0 rgba(255, 205, 210, 1), 5px 8px 0 0 rgba(255, 205, 210, 1), 6px 8px 0 0 rgba(255, 205, 210, 1), 7px 8px 0 0 rgba(255, 205, 210, 1), 8px 8px 0 0 rgba(255, 205, 210, 1), 9px 8px 0 0 rgba(255, 205, 210, 1), 10px 8px 0 0 rgba(255, 205, 210, 1), 11px 8px 0 0 rgba(255, 205, 210, 1), 12px 8px 0 0 rgba(255, 205, 210, 1), 13px 8px 0 0 rgba(255, 205, 210, 1), 14px 8px 0 0 rgba(121, 85, 72, 1), 15px 8px 0 0 rgba(121, 85, 72, 1), 16px 8px 0 0 rgba(121, 85, 72, 1), 2px 9px 0 0 rgba(255, 205, 210, 1), 3px 9px 0 0 rgba(255, 205, 210, 1), 4px 9px 0 0 rgba(255, 205, 210, 1), 5px 9px 0 0 rgba(255, 205, 210, 1), 6px 9px 0 0 rgba(255, 205, 210, 1), 7px 9px 0 0 rgba(255, 205, 210, 1), 8px 9px 0 0 rgba(255, 87, 34, 1), 9px 9px 0 0 rgba(255, 87, 34, 1), 10px 9px 0 0 rgba(255, 205, 210, 1), 11px 9px 0 0 rgba(255, 205, 210, 1), 12px 9px 0 0 rgba(255, 205, 210, 1), 13px 9px 0 0 rgba(255, 205, 210, 1), 14px 9px 0 0 rgba(121, 85, 72, 1), 15px 9px 0 0 rgba(121, 85, 72, 1), 16px 9px 0 0 rgba(121, 85, 72, 1), 3px 10px 0 0 rgba(255, 205, 210, 1), 4px 10px 0 0 rgba(255, 205, 210, 1), 5px 10px 0 0 rgba(255, 205, 210, 1), 6px 10px 0 0 rgba(255, 205, 210, 1), 7px 10px 0 0 rgba(255, 205, 210, 1), 8px 10px 0 0 rgba(255, 205, 210, 1), 9px 10px 0 0 rgba(255, 205, 210, 1), 10px 10px 0 0 rgba(255, 205, 210, 1), 11px 10px 0 0 rgba(255, 205, 210, 1), 12px 10px 0 0 rgba(255, 205, 210, 1), 13px 10px 0 0 rgba(255, 205, 210, 1), 14px 10px 0 0 rgba(121, 85, 72, 1), 15px 10px 0 0 rgba(121, 85, 72, 1), 16px 10px 0 0 rgba(121, 85, 72, 1), 4px 11px 0 0 rgba(255, 205, 210, 1), 5px 11px 0 0 rgba(255, 205, 210, 1), 12px 11px 0 0 rgba(255, 205, 210, 1), 13px 11px 0 0 rgba(255, 205, 210, 1), 14px 11px 0 0 rgba(121, 85, 72, 1), 15px 11px 0 0 rgba(121, 85, 72, 1), 16px 11px 0 0 rgba(121, 85, 72, 1), 4px 12px 0 0 rgba(255, 205, 210, 1), 5px 12px 0 0 rgba(255, 205, 210, 1), 12px 12px 0 0 rgba(255, 205, 210, 1), 13px 12px 0 0 rgba(255, 205, 210, 1), 14px 12px 0 0 rgba(121, 85, 72, 1), 15px 12px 0 0 rgba(121, 85, 72, 1), 16px 12px 0 0 rgba(121, 85, 72, 1);height: 1px; width: 1px;
  }
80.01%, 100%{
  box-shadow: 4px 3px 0 0 rgba(255, 193, 7, 1), 5px 3px 0 0 rgba(255, 193, 7, 1), 6px 3px 0 0 rgba(255, 193, 7, 1), 12px 3px 0 0 rgba(121, 85, 72, 1), 13px 3px 0 0 rgba(121, 85, 72, 1), 14px 3px 0 0 rgba(121, 85, 72, 1), 3px 4px 0 0 rgba(255, 152, 0, 1), 4px 4px 0 0 rgba(255, 152, 0, 1), 5px 4px 0 0 rgba(255, 152, 0, 1), 6px 4px 0 0 rgba(255, 152, 0, 1), 7px 4px 0 0 rgba(255, 193, 7, 1), 11px 4px 0 0 rgba(121, 85, 72, 1), 12px 4px 0 0 rgba(121, 85, 72, 1), 13px 4px 0 0 rgba(121, 85, 72, 1), 14px 4px 0 0 rgba(121, 85, 72, 1), 15px 4px 0 0 rgba(121, 85, 72, 1), 2px 5px 0 0 rgba(255, 193, 7, 1), 3px 5px 0 0 rgba(255, 193, 7, 1), 4px 5px 0 0 rgba(255, 193, 7, 1), 5px 5px 0 0 rgba(255, 193, 7, 1), 6px 5px 0 0 rgba(255, 193, 7, 1), 7px 5px 0 0 rgba(255, 152, 0, 1), 8px 5px 0 0 rgba(255, 193, 7, 1), 10px 5px 0 0 rgba(255, 205, 210, 1), 11px 5px 0 0 rgba(255, 205, 210, 1), 12px 5px 0 0 rgba(121, 85, 72, 1), 13px 5px 0 0 rgba(121, 85, 72, 1), 14px 5px 0 0 rgba(121, 85, 72, 1), 15px 5px 0 0 rgba(121, 85, 72, 1), 16px 5px 0 0 rgba(121, 85, 72, 1), 2px 6px 0 0 rgba(255, 152, 0, 1), 3px 6px 0 0 rgba(255, 152, 0, 1), 4px 6px 0 0 rgba(255, 193, 7, 1), 5px 6px 0 0 rgba(255, 152, 0, 1), 6px 6px 0 0 rgba(255, 205, 210, 1), 7px 6px 0 0 rgba(255, 205, 210, 1), 8px 6px 0 0 rgba(255, 205, 210, 1), 9px 6px 0 0 rgba(255, 205, 210, 1), 10px 6px 0 0 rgba(255, 205, 210, 1), 11px 6px 0 0 rgba(255, 205, 210, 1), 12px 6px 0 0 rgba(255, 205, 210, 1), 13px 6px 0 0 rgba(121, 85, 72, 1), 14px 6px 0 0 rgba(121, 85, 72, 1), 15px 6px 0 0 rgba(121, 85, 72, 1), 16px 6px 0 0 rgba(121, 85, 72, 1), 2px 7px 0 0 rgba(255, 152, 0, 1), 3px 7px 0 0 rgba(255, 152, 0, 1), 4px 7px 0 0 rgba(255, 205, 210, 1), 5px 7px 0 0 rgba(255, 205, 210, 1), 6px 7px 0 0 rgba(255, 205, 210, 1), 7px 7px 0 0 rgba(255, 205, 210, 1), 8px 7px 0 0 rgba(255, 205, 210, 1), 9px 7px 0 0 rgba(255, 205, 210, 1), 10px 7px 0 0 rgba(255, 205, 210, 1), 11px 7px 0 0 rgba(255, 205, 210, 1), 12px 7px 0 0 rgba(255, 205, 210, 1), 13px 7px 0 0 rgba(255, 205, 210, 1), 14px 7px 0 0 rgba(121, 85, 72, 1), 15px 7px 0 0 rgba(121, 85, 72, 1), 16px 7px 0 0 rgba(121, 85, 72, 1), 2px 8px 0 0 rgba(255, 152, 0, 1), 3px 8px 0 0 rgba(255, 205, 210, 1), 4px 8px 0 0 rgba(255, 205, 210, 1), 5px 8px 0 0 rgba(255, 205, 210, 1), 6px 8px 0 0 rgba(255, 205, 210, 1), 7px 8px 0 0 rgba(255, 205, 210, 1), 8px 8px 0 0 rgba(255, 205, 210, 1), 9px 8px 0 0 rgba(255, 205, 210, 1), 10px 8px 0 0 rgba(255, 205, 210, 1), 11px 8px 0 0 rgba(255, 205, 210, 1), 12px 8px 0 0 rgba(255, 205, 210, 1), 13px 8px 0 0 rgba(255, 205, 210, 1), 14px 8px 0 0 rgba(121, 85, 72, 1), 15px 8px 0 0 rgba(121, 85, 72, 1), 16px 8px 0 0 rgba(121, 85, 72, 1), 2px 9px 0 0 rgba(255, 205, 210, 1), 3px 9px 0 0 rgba(255, 205, 210, 1), 4px 9px 0 0 rgba(255, 205, 210, 1), 5px 9px 0 0 rgba(255, 205, 210, 1), 6px 9px 0 0 rgba(255, 205, 210, 1), 7px 9px 0 0 rgba(255, 205, 210, 1), 8px 9px 0 0 rgba(255, 87, 34, 1), 9px 9px 0 0 rgba(255, 87, 34, 1), 10px 9px 0 0 rgba(255, 205, 210, 1), 11px 9px 0 0 rgba(255, 205, 210, 1), 12px 9px 0 0 rgba(255, 205, 210, 1), 13px 9px 0 0 rgba(255, 205, 210, 1), 14px 9px 0 0 rgba(121, 85, 72, 1), 15px 9px 0 0 rgba(121, 85, 72, 1), 16px 9px 0 0 rgba(121, 85, 72, 1), 3px 10px 0 0 rgba(255, 205, 210, 1), 4px 10px 0 0 rgba(255, 205, 210, 1), 5px 10px 0 0 rgba(255, 205, 210, 1), 6px 10px 0 0 rgba(255, 205, 210, 1), 7px 10px 0 0 rgba(255, 205, 210, 1), 8px 10px 0 0 rgba(255, 205, 210, 1), 9px 10px 0 0 rgba(255, 205, 210, 1), 10px 10px 0 0 rgba(255, 205, 210, 1), 11px 10px 0 0 rgba(255, 205, 210, 1), 12px 10px 0 0 rgba(255, 205, 210, 1), 13px 10px 0 0 rgba(255, 205, 210, 1), 14px 10px 0 0 rgba(121, 85, 72, 1), 15px 10px 0 0 rgba(121, 85, 72, 1), 16px 10px 0 0 rgba(121, 85, 72, 1), 4px 11px 0 0 rgba(255, 205, 210, 1), 5px 11px 0 0 rgba(255, 205, 210, 1), 12px 11px 0 0 rgba(255, 205, 210, 1), 13px 11px 0 0 rgba(255, 205, 210, 1), 14px 11px 0 0 rgba(121, 85, 72, 1), 15px 11px 0 0 rgba(121, 85, 72, 1), 16px 11px 0 0 rgba(121, 85, 72, 1), 4px 12px 0 0 rgba(255, 0, 0, 1), 5px 12px 0 0 rgba(255, 0, 0, 1), 6px 12px 0 0 rgba(255, 0, 0, 1), 8px 12px 0 0 rgba(255, 0, 0, 1), 9px 12px 0 0 rgba(255, 0, 0, 1), 10px 12px 0 0 rgba(255, 0, 0, 1), 12px 12px 0 0 rgba(255, 0, 0, 1), 13px 12px 0 0 rgba(255, 205, 210, 1), 14px 12px 0 0 rgba(255, 0, 0, 1), 15px 12px 0 0 rgba(121, 85, 72, 1), 16px 12px 0 0 rgba(121, 85, 72, 1), 4px 13px 0 0 rgba(255, 0, 0, 1), 8px 13px 0 0 rgba(255, 0, 0, 1), 13px 13px 0 0 rgba(255, 0, 0, 1), 5px 14px 0 0 rgba(255, 0, 0, 1), 6px 14px 0 0 rgba(255, 0, 0, 1), 8px 14px 0 0 rgba(255, 0, 0, 1), 9px 14px 0 0 rgba(255, 0, 0, 1), 13px 14px 0 0 rgba(255, 0, 0, 1), 6px 15px 0 0 rgba(255, 0, 0, 1), 8px 15px 0 0 rgba(255, 0, 0, 1), 13px 15px 0 0 rgba(255, 0, 0, 1), 4px 16px 0 0 rgba(255, 0, 0, 1), 5px 16px 0 0 rgba(255, 0, 0, 1), 6px 16px 0 0 rgba(255, 0, 0, 1), 8px 16px 0 0 rgba(255, 0, 0, 1), 9px 16px 0 0 rgba(255, 0, 0, 1), 10px 16px 0 0 rgba(255, 0, 0, 1), 12px 16px 0 0 rgba(255, 0, 0, 1), 14px 16px 0 0 rgba(255, 0, 0, 1);height: 1px; width: 1px;
  }
}
...
@keyframes x {
0%, 25%{
  box-shadow: 1px 1px 0 0 #303f46, 2px 1px 0 0 #303f46, 3px 1px 0 0 #303f46, 4px 1px 0 0 #303f46, 5px 1px 0 0 #303f46, 6px 1px 0 0 #303f46, 7px 1px 0 0 #ffffff, 8px 1px 0 0 #303f46, 9px 1px 0 0 #303f46, 10px 1px 0 0 #303f46, 11px 1px 0 0 #303f46, 12px 1px 0 0 #ffffff, 13px 1px 0 0 #303f46, 14px 1px 0 0 #303f46, 15px 1px 0 0 #303f46, 16px 1px 0 0 #303f46, 1px 2px 0 0 #303f46, 2px 2px 0 0 #303f46, 3px 2px 0 0 #303f46, 4px 2px 0 0 #303f46, 5px 2px 0 0 #303f46, 6px 2px 0 0 #ffffff, 7px 2px 0 0 #ffcdd2, 8px 2px 0 0 #ffffff, 9px 2px 0 0 #303f46, 10px 2px 0 0 #303f46, 11px 2px 0 0 #ffffff, 12px 2px 0 0 #ffcdd2, 13px 2px 0 0 #ffffff, 14px 2px 0 0 #303f46, 15px 2px 0 0 #303f46, 16px 2px 0 0 #303f46, 1px 3px 0 0 #303f46, 2px 3px 0 0 #303f46, 3px 3px 0 0 #303f46, 4px 3px 0 0 #303f46, 5px 3px 0 0 #303f46, 6px 3px 0 0 #ffffff, 7px 3px 0 0 #ffcdd2, 8px 3px 0 0 #ffcdd2, 9px 3px 0 0 #ffffff, 10px 3px 0 0 #ffffff, 11px 3px 0 0 #ffcdd2, 12px 3px 0 0 #ffcdd2, 13px 3px 0 0 #ffffff, 14px 3px 0 0 #303f46, 15px 3px 0 0 #303f46, 16px 3px 0 0 #303f46, 1px 4px 0 0 #303f46, 2px 4px 0 0 #303f46, 3px 4px 0 0 #303f46, 4px 4px 0 0 #303f46, 5px 4px 0 0 #303f46, 6px 4px 0 0 #ffffff, 7px 4px 0 0 #ffcdd2, 8px 4px 0 0 #ffffff, 9px 4px 0 0 #ffffff, 10px 4px 0 0 #ffffff, 11px 4px 0 0 #ffffff, 12px 4px 0 0 #ffcdd2, 13px 4px 0 0 #ffffff, 14px 4px 0 0 #303f46, 15px 4px 0 0 #303f46, 16px 4px 0 0 #303f46, 1px 5px 0 0 #303f46, 2px 5px 0 0 #303f46, 3px 5px 0 0 #303f46, 4px 5px 0 0 #303f46, 5px 5px 0 0 #303f46, 6px 5px 0 0 #ffffff, 7px 5px 0 0 #ffffff, 8px 5px 0 0 #ffffff, 9px 5px 0 0 #ffffff, 10px 5px 0 0 #ffffff, 11px 5px 0 0 #ffffff, 12px 5px 0 0 #ffffff, 13px 5px 0 0 #ffffff, 14px 5px 0 0 #303f46, 15px 5px 0 0 #303f46, 16px 5px 0 0 #303f46, 1px 6px 0 0 #303f46, 2px 6px 0 0 #303f46, 3px 6px 0 0 #303f46, 4px 6px 0 0 #303f46, 5px 6px 0 0 #303f46, 6px 6px 0 0 #ffffff, 7px 6px 0 0 #000000, 8px 6px 0 0 #ffffff, 9px 6px 0 0 #ffffff, 10px 6px 0 0 #000000, 11px 6px 0 0 #ffffff, 12px 6px 0 0 #ffffff, 13px 6px 0 0 #ffffff, 14px 6px 0 0 #303f46, 15px 6px 0 0 #303f46, 16px 6px 0 0 #303f46, 1px 7px 0 0 #303f46, 2px 7px 0 0 #303f46, 3px 7px 0 0 #303f46, 4px 7px 0 0 #303f46, 5px 7px 0 0 #303f46, 6px 7px 0 0 #ffffff, 7px 7px 0 0 #ffffff, 8px 7px 0 0 #000000, 9px 7px 0 0 #ffffff, 10px 7px 0 0 #ffffff, 11px 7px 0 0 #ffffff, 12px 7px 0 0 #ffffff, 13px 7px 0 0 #ffffff, 14px 7px 0 0 #303f46, 15px 7px 0 0 #303f46, 16px 7px 0 0 #303f46, 1px 8px 0 0 #303f46, 2px 8px 0 0 #303f46, 3px 8px 0 0 #303f46, 4px 8px 0 0 #303f46, 5px 8px 0 0 #303f46, 6px 8px 0 0 #ffffff, 7px 8px 0 0 #ffffff, 8px 8px 0 0 #ffffff, 9px 8px 0 0 #ffffff, 10px 8px 0 0 #ffffff, 11px 8px 0 0 #ffffff, 12px 8px 0 0 #ffffff, 13px 8px 0 0 #ffffff, 14px 8px 0 0 #303f46, 15px 8px 0 0 #303f46, 16px 8px 0 0 #303f46, 1px 9px 0 0 #303f46, 2px 9px 0 0 #303f46, 3px 9px 0 0 #303f46, 4px 9px 0 0 #303f46, 5px 9px 0 0 #303f46, 6px 9px 0 0 #303f46, 7px 9px 0 0 #ffffff, 8px 9px 0 0 #ffffff, 9px 9px 0 0 #ffffff, 10px 9px 0 0 #ffffff, 11px 9px 0 0 #ffffff, 12px 9px 0 0 #ffffff, 13px 9px 0 0 #303f46, 14px 9px 0 0 #303f46, 15px 9px 0 0 #303f46, 16px 9px 0 0 #303f46, 1px 10px 0 0 #303f46, 2px 10px 0 0 #303f46, 3px 10px 0 0 #303f46, 4px 10px 0 0 #303f46, 5px 10px 0 0 #303f46, 6px 10px 0 0 #303f46, 7px 10px 0 0 #303f46, 8px 10px 0 0 #ffffff, 9px 10px 0 0 #ffffff, 10px 10px 0 0 #ffffff, 11px 10px 0 0 #ffffff, 12px 10px 0 0 #303f46, 13px 10px 0 0 #303f46, 14px 10px 0 0 #ffffff, 15px 10px 0 0 #303f46, 16px 10px 0 0 #303f46, 1px 11px 0 0 #303f46, 2px 11px 0 0 #303f46, 3px 11px 0 0 #303f46, 4px 11px 0 0 #303f46, 5px 11px 0 0 #303f46, 6px 11px 0 0 #303f46, 7px 11px 0 0 #303f46, 8px 11px 0 0 #ffffff, 9px 11px 0 0 #ffffff, 10px 11px 0 0 #ffffff, 11px 11px 0 0 #ffffff, 12px 11px 0 0 #303f46, 13px 11px 0 0 #303f46, 14px 11px 0 0 #303f46, 15px 11px 0 0 #ffffff, 16px 11px 0 0 #303f46, 1px 12px 0 0 #303f46, 2px 12px 0 0 #303f46, 3px 12px 0 0 #303f46, 4px 12px 0 0 #303f46, 5px 12px 0 0 #303f46, 6px 12px 0 0 #303f46, 7px 12px 0 0 #ffffff, 8px 12px 0 0 #ffffff, 9px 12px 0 0 #ffffff, 10px 12px 0 0 #ffffff, 11px 12px 0 0 #ffffff, 12px 12px 0 0 #ffffff, 13px 12px 0 0 #303f46, 14px 12px 0 0 #303f46, 15px 12px 0 0 #ffffff, 16px 12px 0 0 #303f46, 1px 13px 0 0 #303f46, 2px 13px 0 0 #303f46, 3px 13px 0 0 #303f46, 4px 13px 0 0 #303f46, 5px 13px 0 0 #ffffff, 6px 13px 0 0 #ffffff, 7px 13px 0 0 #ffffff, 8px 13px 0 0 #ffffff, 9px 13px 0 0 #ffffff, 10px 13px 0 0 #ffffff, 11px 13px 0 0 #ffffff, 12px 13px 0 0 #ffffff, 13px 13px 0 0 #303f46, 14px 13px 0 0 #303f46, 15px 13px 0 0 #ffffff, 16px 13px 0 0 #303f46, 1px 14px 0 0 #303f46, 2px 14px 0 0 #303f46, 3px 14px 0 0 #303f46, 4px 14px 0 0 #303f46, 5px 14px 0 0 #ffffff, 6px 14px 0 0 #ffffff, 7px 14px 0 0 #ffffff, 8px 14px 0 0 #ffffff, 9px 14px 0 0 #ffffff, 10px 14px 0 0 #ffffff, 11px 14px 0 0 #ffffff, 12px 14px 0 0 #ffffff, 13px 14px 0 0 #303f46, 14px 14px 0 0 #ffffff, 15px 14px 0 0 #ffffff, 16px 14px 0 0 #303f46, 1px 15px 0 0 #303f46, 2px 15px 0 0 #303f46, 3px 15px 0 0 #303f46, 4px 15px 0 0 #ffffff, 5px 15px 0 0 #ffffff, 6px 15px 0 0 #ffffff, 7px 15px 0 0 #ffffff, 8px 15px 0 0 #ffffff, 9px 15px 0 0 #ffffff, 10px 15px 0 0 #ffffff, 11px 15px 0 0 #ffffff, 12px 15px 0 0 #ffffff, 13px 15px 0 0 #ffffff, 14px 15px 0 0 #ffffff, 15px 15px 0 0 #303f46, 16px 15px 0 0 #303f46, 1px 16px 0 0 #607d8b, 2px 16px 0 0 #607d8b, 3px 16px 0 0 #607d8b, 4px 16px 0 0 #607d8b, 5px 16px 0 0 #607d8b, 6px 16px 0 0 #ffffff, 7px 16px 0 0 #ffffff, 8px 16px 0 0 #607d8b, 9px 16px 0 0 #607d8b, 10px 16px 0 0 #607d8b, 11px 16px 0 0 #ffffff, 12px 16px 0 0 #ffffff, 13px 16px 0 0 #607d8b, 14px 16px 0 0 #607d8b, 15px 16px 0 0 #607d8b, 16px 16px 0 0 #607d8b;height: 1px; width: 1px;
  }
25.01%, 50%{
  box-shadow: 1px 1px 0 0 #303f46, 2px 1px 0 0 #303f46, 3px 1px 0 0 #303f46, 4px 1px 0 0 #303f46, 5px 1px 0 0 #303f46, 6px 1px 0 0 #303f46, 7px 1px 0 0 #ffffff, 8px 1px 0 0 #303f46, 9px 1px 0 0 #303f46, 10px 1px 0 0 #303f46, 11px 1px 0 0 #303f46, 12px 1px 0 0 #ffffff, 13px 1px 0 0 #303f46, 14px 1px 0 0 #303f46, 15px 1px 0 0 #303f46, 16px 1px 0 0 #303f46, 1px 2px 0 0 #303f46, 2px 2px 0 0 #303f46, 3px 2px 0 0 #303f46, 4px 2px 0 0 #303f46, 5px 2px 0 0 #303f46, 6px 2px 0 0 #ffffff, 7px 2px 0 0 #ffcdd2, 8px 2px 0 0 #ffffff, 9px 2px 0 0 #303f46, 10px 2px 0 0 #303f46, 11px 2px 0 0 #ffffff, 12px 2px 0 0 #ffcdd2, 13px 2px 0 0 #ffffff, 14px 2px 0 0 #303f46, 15px 2px 0 0 #303f46, 16px 2px 0 0 #303f46, 1px 3px 0 0 #303f46, 2px 3px 0 0 #303f46, 3px 3px 0 0 #303f46, 4px 3px 0 0 #303f46, 5px 3px 0 0 #303f46, 6px 3px 0 0 #ffffff, 7px 3px 0 0 #ffcdd2, 8px 3px 0 0 #ffcdd2, 9px 3px 0 0 #ffffff, 10px 3px 0 0 #ffffff, 11px 3px 0 0 #ffcdd2, 12px 3px 0 0 #ffcdd2, 13px 3px 0 0 #ffffff, 14px 3px 0 0 #303f46, 15px 3px 0 0 #303f46, 16px 3px 0 0 #303f46, 1px 4px 0 0 #303f46, 2px 4px 0 0 #303f46, 3px 4px 0 0 #303f46, 4px 4px 0 0 #303f46, 5px 4px 0 0 #303f46, 6px 4px 0 0 #ffffff, 7px 4px 0 0 #ffcdd2, 8px 4px 0 0 #ffffff, 9px 4px 0 0 #ffffff, 10px 4px 0 0 #ffffff, 11px 4px 0 0 #ffffff, 12px 4px 0 0 #ffcdd2, 13px 4px 0 0 #ffffff, 14px 4px 0 0 #303f46, 15px 4px 0 0 #303f46, 16px 4px 0 0 #303f46, 1px 5px 0 0 #303f46, 2px 5px 0 0 #303f46, 3px 5px 0 0 #303f46, 4px 5px 0 0 #303f46, 5px 5px 0 0 #303f46, 6px 5px 0 0 #ffffff, 7px 5px 0 0 #ffffff, 8px 5px 0 0 #ffffff, 9px 5px 0 0 #ffffff, 10px 5px 0 0 #ffffff, 11px 5px 0 0 #ffffff, 12px 5px 0 0 #ffffff, 13px 5px 0 0 #ffffff, 14px 5px 0 0 #303f46, 15px 5px 0 0 #303f46, 16px 5px 0 0 #303f46, 1px 6px 0 0 #303f46, 2px 6px 0 0 #303f46, 3px 6px 0 0 #303f46, 4px 6px 0 0 #303f46, 5px 6px 0 0 #303f46, 6px 6px 0 0 #ffffff, 7px 6px 0 0 #ffffff, 8px 6px 0 0 #000000, 9px 6px 0 0 #ffffff, 10px 6px 0 0 #ffffff, 11px 6px 0 0 #000000, 12px 6px 0 0 #ffffff, 13px 6px 0 0 #ffffff, 14px 6px 0 0 #303f46, 15px 6px 0 0 #303f46, 16px 6px 0 0 #303f46, 1px 7px 0 0 #303f46, 2px 7px 0 0 #303f46, 3px 7px 0 0 #303f46, 4px 7px 0 0 #303f46, 5px 7px 0 0 #303f46, 6px 7px 0 0 #ffffff, 7px 7px 0 0 #ffffff, 8px 7px 0 0 #ffffff, 9px 7px 0 0 #ffffff, 10px 7px 0 0 #000000, 11px 7px 0 0 #ffffff, 12px 7px 0 0 #ffffff, 13px 7px 0 0 #ffffff, 14px 7px 0 0 #303f46, 15px 7px 0 0 #303f46, 16px 7px 0 0 #303f46, 1px 8px 0 0 #303f46, 2px 8px 0 0 #303f46, 3px 8px 0 0 #303f46, 4px 8px 0 0 #303f46, 5px 8px 0 0 #303f46, 6px 8px 0 0 #ffffff, 7px 8px 0 0 #ffffff, 8px 8px 0 0 #ffffff, 9px 8px 0 0 #ffffff, 10px 8px 0 0 #ffffff, 11px 8px 0 0 #ffffff, 12px 8px 0 0 #ffffff, 13px 8px 0 0 #ffffff, 14px 8px 0 0 #303f46, 15px 8px 0 0 #303f46, 16px 8px 0 0 #303f46, 1px 9px 0 0 #303f46, 2px 9px 0 0 #303f46, 3px 9px 0 0 #303f46, 4px 9px 0 0 #303f46, 5px 9px 0 0 #303f46, 6px 9px 0 0 #303f46, 7px 9px 0 0 #ffffff, 8px 9px 0 0 #ffffff, 9px 9px 0 0 #ffffff, 10px 9px 0 0 #ffffff, 11px 9px 0 0 #ffffff, 12px 9px 0 0 #ffffff, 13px 9px 0 0 #303f46, 14px 9px 0 0 #303f46, 15px 9px 0 0 #303f46, 16px 9px 0 0 #303f46, 1px 10px 0 0 #303f46, 2px 10px 0 0 #303f46, 3px 10px 0 0 #303f46, 4px 10px 0 0 #303f46, 5px 10px 0 0 #303f46, 6px 10px 0 0 #303f46, 7px 10px 0 0 #303f46, 8px 10px 0 0 #ffffff, 9px 10px 0 0 #ffffff, 10px 10px 0 0 #ffffff, 11px 10px 0 0 #ffffff, 12px 10px 0 0 #303f46, 13px 10px 0 0 #303f46, 14px 10px 0 0 #ffffff, 15px 10px 0 0 #303f46, 16px 10px 0 0 #303f46, 1px 11px 0 0 #303f46, 2px 11px 0 0 #303f46, 3px 11px 0 0 #303f46, 4px 11px 0 0 #303f46, 5px 11px 0 0 #303f46, 6px 11px 0 0 #303f46, 7px 11px 0 0 #303f46, 8px 11px 0 0 #ffffff, 9px 11px 0 0 #ffffff, 10px 11px 0 0 #ffffff, 11px 11px 0 0 #ffffff, 12px 11px 0 0 #303f46, 13px 11px 0 0 #303f46, 14px 11px 0 0 #303f46, 15px 11px 0 0 #ffffff, 16px 11px 0 0 #303f46, 1px 12px 0 0 #303f46, 2px 12px 0 0 #303f46, 3px 12px 0 0 #303f46, 4px 12px 0 0 #303f46, 5px 12px 0 0 #303f46, 6px 12px 0 0 #303f46, 7px 12px 0 0 #ffffff, 8px 12px 0 0 #ffffff, 9px 12px 0 0 #ffffff, 10px 12px 0 0 #ffffff, 11px 12px 0 0 #ffffff, 12px 12px 0 0 #ffffff, 13px 12px 0 0 #303f46, 14px 12px 0 0 #303f46, 15px 12px 0 0 #ffffff, 16px 12px 0 0 #303f46, 1px 13px 0 0 #303f46, 2px 13px 0 0 #303f46, 3px 13px 0 0 #303f46, 4px 13px 0 0 #303f46, 5px 13px 0 0 #ffffff, 6px 13px 0 0 #ffffff, 7px 13px 0 0 #ffffff, 8px 13px 0 0 #ffffff, 9px 13px 0 0 #ffffff, 10px 13px 0 0 #ffffff, 11px 13px 0 0 #ffffff, 12px 13px 0 0 #ffffff, 13px 13px 0 0 #303f46, 14px 13px 0 0 #303f46, 15px 13px 0 0 #ffffff, 16px 13px 0 0 #303f46, 1px 14px 0 0 #303f46, 2px 14px 0 0 #303f46, 3px 14px 0 0 #303f46, 4px 14px 0 0 #303f46, 5px 14px 0 0 #ffffff, 6px 14px 0 0 #ffffff, 7px 14px 0 0 #ffffff, 8px 14px 0 0 #ffffff, 9px 14px 0 0 #ffffff, 10px 14px 0 0 #ffffff, 11px 14px 0 0 #ffffff, 12px 14px 0 0 #ffffff, 13px 14px 0 0 #303f46, 14px 14px 0 0 #ffffff, 15px 14px 0 0 #ffffff, 16px 14px 0 0 #303f46, 1px 15px 0 0 #303f46, 2px 15px 0 0 #303f46, 3px 15px 0 0 #303f46, 4px 15px 0 0 #ffffff, 5px 15px 0 0 #ffffff, 6px 15px 0 0 #ffffff, 7px 15px 0 0 #ffffff, 8px 15px 0 0 #ffffff, 9px 15px 0 0 #ffffff, 10px 15px 0 0 #ffffff, 11px 15px 0 0 #ffffff, 12px 15px 0 0 #ffffff, 13px 15px 0 0 #ffffff, 14px 15px 0 0 #ffffff, 15px 15px 0 0 #303f46, 16px 15px 0 0 #303f46, 1px 16px 0 0 #607d8b, 2px 16px 0 0 #607d8b, 3px 16px 0 0 #607d8b, 4px 16px 0 0 #607d8b, 5px 16px 0 0 #607d8b, 6px 16px 0 0 #ffffff, 7px 16px 0 0 #ffffff, 8px 16px 0 0 #607d8b, 9px 16px 0 0 #607d8b, 10px 16px 0 0 #607d8b, 11px 16px 0 0 #ffffff, 12px 16px 0 0 #ffffff, 13px 16px 0 0 #607d8b, 14px 16px 0 0 #607d8b, 15px 16px 0 0 #607d8b, 16px 16px 0 0 #607d8b;height: 1px; width: 1px;
  }
50.01%, 75%{
  box-shadow: 1px 1px 0 0 #303f46, 2px 1px 0 0 #303f46, 3px 1px 0 0 #303f46, 4px 1px 0 0 #303f46, 5px 1px 0 0 #303f46, 6px 1px 0 0 #303f46, 7px 1px 0 0 #ffffff, 8px 1px 0 0 #303f46, 9px 1px 0 0 #303f46, 10px 1px 0 0 #303f46, 11px 1px 0 0 #303f46, 12px 1px 0 0 #ffffff, 13px 1px 0 0 #303f46, 14px 1px 0 0 #303f46, 15px 1px 0 0 #303f46, 16px 1px 0 0 #303f46, 1px 2px 0 0 #303f46, 2px 2px 0 0 #303f46, 3px 2px 0 0 #303f46, 4px 2px 0 0 #303f46, 5px 2px 0 0 #303f46, 6px 2px 0 0 #ffffff, 7px 2px 0 0 #ffcdd2, 8px 2px 0 0 #ffffff, 9px 2px 0 0 #303f46, 10px 2px 0 0 #303f46, 11px 2px 0 0 #ffffff, 12px 2px 0 0 #ffcdd2, 13px 2px 0 0 #ffffff, 14px 2px 0 0 #303f46, 15px 2px 0 0 #303f46, 16px 2px 0 0 #303f46, 1px 3px 0 0 #303f46, 2px 3px 0 0 #303f46, 3px 3px 0 0 #303f46, 4px 3px 0 0 #303f46, 5px 3px 0 0 #303f46, 6px 3px 0 0 #ffffff, 7px 3px 0 0 #ffcdd2, 8px 3px 0 0 #ffcdd2, 9px 3px 0 0 #ffffff, 10px 3px 0 0 #ffffff, 11px 3px 0 0 #ffcdd2, 12px 3px 0 0 #ffcdd2, 13px 3px 0 0 #ffffff, 14px 3px 0 0 #303f46, 15px 3px 0 0 #303f46, 16px 3px 0 0 #303f46, 1px 4px 0 0 #303f46, 2px 4px 0 0 #303f46, 3px 4px 0 0 #303f46, 4px 4px 0 0 #303f46, 5px 4px 0 0 #303f46, 6px 4px 0 0 #ffffff, 7px 4px 0 0 #ffcdd2, 8px 4px 0 0 #ffffff, 9px 4px 0 0 #ffffff, 10px 4px 0 0 #ffffff, 11px 4px 0 0 #ffffff, 12px 4px 0 0 #ffcdd2, 13px 4px 0 0 #ffffff, 14px 4px 0 0 #303f46, 15px 4px 0 0 #303f46, 16px 4px 0 0 #303f46, 1px 5px 0 0 #303f46, 2px 5px 0 0 #303f46, 3px 5px 0 0 #303f46, 4px 5px 0 0 #303f46, 5px 5px 0 0 #303f46, 6px 5px 0 0 #ffffff, 7px 5px 0 0 #ffffff, 8px 5px 0 0 #ffffff, 9px 5px 0 0 #ffffff, 10px 5px 0 0 #ffffff, 11px 5px 0 0 #ffffff, 12px 5px 0 0 #ffffff, 13px 5px 0 0 #ffffff, 14px 5px 0 0 #303f46, 15px 5px 0 0 #303f46, 16px 5px 0 0 #303f46, 1px 6px 0 0 #303f46, 2px 6px 0 0 #303f46, 3px 6px 0 0 #303f46, 4px 6px 0 0 #303f46, 5px 6px 0 0 #303f46, 6px 6px 0 0 #ffffff, 7px 6px 0 0 #ffffff, 8px 6px 0 0 #000000, 9px 6px 0 0 #ffffff, 10px 6px 0 0 #ffffff, 11px 6px 0 0 #000000, 12px 6px 0 0 #ffffff, 13px 6px 0 0 #ffffff, 14px 6px 0 0 #303f46, 15px 6px 0 0 #303f46, 16px 6px 0 0 #303f46, 1px 7px 0 0 #303f46, 2px 7px 0 0 #303f46, 3px 7px 0 0 #303f46, 4px 7px 0 0 #303f46, 5px 7px 0 0 #303f46, 6px 7px 0 0 #ffffff, 7px 7px 0 0 #ffffff, 8px 7px 0 0 #ffffff, 9px 7px 0 0 #ffffff, 10px 7px 0 0 #000000, 11px 7px 0 0 #ffffff, 12px 7px 0 0 #ffffff, 13px 7px 0 0 #ffffff, 14px 7px 0 0 #303f46, 15px 7px 0 0 #303f46, 16px 7px 0 0 #303f46, 1px 8px 0 0 #303f46, 2px 8px 0 0 #303f46, 3px 8px 0 0 #303f46, 4px 8px 0 0 #303f46, 5px 8px 0 0 #303f46, 6px 8px 0 0 #ffffff, 7px 8px 0 0 #ffffff, 8px 8px 0 0 #ffffff, 9px 8px 0 0 #ffffff, 10px 8px 0 0 #ffffff, 11px 8px 0 0 #ffffff, 12px 8px 0 0 #ffffff, 13px 8px 0 0 #ffffff, 14px 8px 0 0 #303f46, 15px 8px 0 0 #303f46, 16px 8px 0 0 #303f46, 1px 9px 0 0 #303f46, 2px 9px 0 0 #303f46, 3px 9px 0 0 #303f46, 4px 9px 0 0 #303f46, 5px 9px 0 0 #303f46, 6px 9px 0 0 #303f46, 7px 9px 0 0 #ffffff, 8px 9px 0 0 #ffffff, 9px 9px 0 0 #ffffff, 10px 9px 0 0 #ffffff, 11px 9px 0 0 #ffffff, 12px 9px 0 0 #ffffff, 13px 9px 0 0 #303f46, 14px 9px 0 0 #303f46, 15px 9px 0 0 #303f46, 16px 9px 0 0 #303f46, 1px 10px 0 0 #303f46, 2px 10px 0 0 #303f46, 3px 10px 0 0 #303f46, 4px 10px 0 0 #303f46, 5px 10px 0 0 #303f46, 6px 10px 0 0 #303f46, 7px 10px 0 0 #303f46, 8px 10px 0 0 #ffffff, 9px 10px 0 0 #ffffff, 10px 10px 0 0 #ffffff, 11px 10px 0 0 #ffffff, 12px 10px 0 0 #303f46, 13px 10px 0 0 #303f46, 14px 10px 0 0 #303f46, 15px 10px 0 0 #303f46, 16px 10px 0 0 #ffffff, 1px 11px 0 0 #303f46, 2px 11px 0 0 #303f46, 3px 11px 0 0 #303f46, 4px 11px 0 0 #303f46, 5px 11px 0 0 #303f46, 6px 11px 0 0 #303f46, 7px 11px 0 0 #303f46, 8px 11px 0 0 #ffffff, 9px 11px 0 0 #ffffff, 10px 11px 0 0 #ffffff, 11px 11px 0 0 #ffffff, 12px 11px 0 0 #303f46, 13px 11px 0 0 #303f46, 14px 11px 0 0 #303f46, 15px 11px 0 0 #ffffff, 16px 11px 0 0 #303f46, 1px 12px 0 0 #303f46, 2px 12px 0 0 #303f46, 3px 12px 0 0 #303f46, 4px 12px 0 0 #303f46, 5px 12px 0 0 #303f46, 6px 12px 0 0 #303f46, 7px 12px 0 0 #ffffff, 8px 12px 0 0 #ffffff, 9px 12px 0 0 #ffffff, 10px 12px 0 0 #ffffff, 11px 12px 0 0 #ffffff, 12px 12px 0 0 #ffffff, 13px 12px 0 0 #303f46, 14px 12px 0 0 #303f46, 15px 12px 0 0 #ffffff, 16px 12px 0 0 #303f46, 1px 13px 0 0 #303f46, 2px 13px 0 0 #303f46, 3px 13px 0 0 #303f46, 4px 13px 0 0 #303f46, 5px 13px 0 0 #ffffff, 6px 13px 0 0 #ffffff, 7px 13px 0 0 #ffffff, 8px 13px 0 0 #ffffff, 9px 13px 0 0 #ffffff, 10px 13px 0 0 #ffffff, 11px 13px 0 0 #ffffff, 12px 13px 0 0 #ffffff, 13px 13px 0 0 #303f46, 14px 13px 0 0 #303f46, 15px 13px 0 0 #ffffff, 16px 13px 0 0 #303f46, 1px 14px 0 0 #303f46, 2px 14px 0 0 #303f46, 3px 14px 0 0 #303f46, 4px 14px 0 0 #303f46, 5px 14px 0 0 #ffffff, 6px 14px 0 0 #ffffff, 7px 14px 0 0 #ffffff, 8px 14px 0 0 #ffffff, 9px 14px 0 0 #ffffff, 10px 14px 0 0 #ffffff, 11px 14px 0 0 #ffffff, 12px 14px 0 0 #ffffff, 13px 14px 0 0 #303f46, 14px 14px 0 0 #ffffff, 15px 14px 0 0 #ffffff, 16px 14px 0 0 #303f46, 1px 15px 0 0 #303f46, 2px 15px 0 0 #303f46, 3px 15px 0 0 #303f46, 4px 15px 0 0 #ffffff, 5px 15px 0 0 #ffffff, 6px 15px 0 0 #ffffff, 7px 15px 0 0 #ffffff, 8px 15px 0 0 #ffffff, 9px 15px 0 0 #ffffff, 10px 15px 0 0 #ffffff, 11px 15px 0 0 #ffffff, 12px 15px 0 0 #ffffff, 13px 15px 0 0 #ffffff, 14px 15px 0 0 #ffffff, 15px 15px 0 0 #303f46, 16px 15px 0 0 #303f46, 1px 16px 0 0 #607d8b, 2px 16px 0 0 #607d8b, 3px 16px 0 0 #607d8b, 4px 16px 0 0 #607d8b, 5px 16px 0 0 #607d8b, 6px 16px 0 0 #ffffff, 7px 16px 0 0 #ffffff, 8px 16px 0 0 #607d8b, 9px 16px 0 0 #607d8b, 10px 16px 0 0 #607d8b, 11px 16px 0 0 #ffffff, 12px 16px 0 0 #ffffff, 13px 16px 0 0 #607d8b, 14px 16px 0 0 #607d8b, 15px 16px 0 0 #607d8b, 16px 16px 0 0 #607d8b;height: 1px; width: 1px;
  }
75.01%, 100%{
  box-shadow: 1px 1px 0 0 #303f46, 2px 1px 0 0 #303f46, 3px 1px 0 0 #303f46, 4px 1px 0 0 #303f46, 5px 1px 0 0 #303f46, 6px 1px 0 0 #303f46, 7px 1px 0 0 #ffffff, 8px 1px 0 0 #303f46, 9px 1px 0 0 #303f46, 10px 1px 0 0 #303f46, 11px 1px 0 0 #303f46, 12px 1px 0 0 #ffffff, 13px 1px 0 0 #303f46, 14px 1px 0 0 #303f46, 15px 1px 0 0 #303f46, 16px 1px 0 0 #303f46, 1px 2px 0 0 #303f46, 2px 2px 0 0 #303f46, 3px 2px 0 0 #303f46, 4px 2px 0 0 #303f46, 5px 2px 0 0 #303f46, 6px 2px 0 0 #ffffff, 7px 2px 0 0 #ffcdd2, 8px 2px 0 0 #ffffff, 9px 2px 0 0 #303f46, 10px 2px 0 0 #303f46, 11px 2px 0 0 #ffffff, 12px 2px 0 0 #ffcdd2, 13px 2px 0 0 #ffffff, 14px 2px 0 0 #303f46, 15px 2px 0 0 #303f46, 16px 2px 0 0 #303f46, 1px 3px 0 0 #303f46, 2px 3px 0 0 #303f46, 3px 3px 0 0 #303f46, 4px 3px 0 0 #303f46, 5px 3px 0 0 #303f46, 6px 3px 0 0 #ffffff, 7px 3px 0 0 #ffcdd2, 8px 3px 0 0 #ffcdd2, 9px 3px 0 0 #ffffff, 10px 3px 0 0 #ffffff, 11px 3px 0 0 #ffcdd2, 12px 3px 0 0 #ffcdd2, 13px 3px 0 0 #ffffff, 14px 3px 0 0 #303f46, 15px 3px 0 0 #303f46, 16px 3px 0 0 #303f46, 1px 4px 0 0 #303f46, 2px 4px 0 0 #303f46, 3px 4px 0 0 #303f46, 4px 4px 0 0 #303f46, 5px 4px 0 0 #303f46, 6px 4px 0 0 #ffffff, 7px 4px 0 0 #ffcdd2, 8px 4px 0 0 #ffffff, 9px 4px 0 0 #ffffff, 10px 4px 0 0 #ffffff, 11px 4px 0 0 #ffffff, 12px 4px 0 0 #ffcdd2, 13px 4px 0 0 #ffffff, 14px 4px 0 0 #303f46, 15px 4px 0 0 #303f46, 16px 4px 0 0 #303f46, 1px 5px 0 0 #303f46, 2px 5px 0 0 #303f46, 3px 5px 0 0 #303f46, 4px 5px 0 0 #303f46, 5px 5px 0 0 #303f46, 6px 5px 0 0 #ffffff, 7px 5px 0 0 #ffffff, 8px 5px 0 0 #ffffff, 9px 5px 0 0 #ffffff, 10px 5px 0 0 #ffffff, 11px 5px 0 0 #ffffff, 12px 5px 0 0 #ffffff, 13px 5px 0 0 #ffffff, 14px 5px 0 0 #303f46, 15px 5px 0 0 #303f46, 16px 5px 0 0 #303f46, 1px 6px 0 0 #303f46, 2px 6px 0 0 #303f46, 3px 6px 0 0 #303f46, 4px 6px 0 0 #303f46, 5px 6px 0 0 #303f46, 6px 6px 0 0 #ffffff, 7px 6px 0 0 #ffffff, 8px 6px 0 0 #000000, 9px 6px 0 0 #ffffff, 10px 6px 0 0 #ffffff, 11px 6px 0 0 #000000, 12px 6px 0 0 #ffffff, 13px 6px 0 0 #ffffff, 14px 6px 0 0 #303f46, 15px 6px 0 0 #303f46, 16px 6px 0 0 #303f46, 1px 7px 0 0 #303f46, 2px 7px 0 0 #303f46, 3px 7px 0 0 #303f46, 4px 7px 0 0 #303f46, 5px 7px 0 0 #303f46, 6px 7px 0 0 #ffffff, 7px 7px 0 0 #ffffff, 8px 7px 0 0 #ffffff, 9px 7px 0 0 #ffffff, 10px 7px 0 0 #000000, 11px 7px 0 0 #ffffff, 12px 7px 0 0 #ffffff, 13px 7px 0 0 #ffffff, 14px 7px 0 0 #303f46, 15px 7px 0 0 #303f46, 16px 7px 0 0 #303f46, 1px 8px 0 0 #303f46, 2px 8px 0 0 #303f46, 3px 8px 0 0 #303f46, 4px 8px 0 0 #303f46, 5px 8px 0 0 #303f46, 6px 8px 0 0 #ffffff, 7px 8px 0 0 #ffffff, 8px 8px 0 0 #ffffff, 9px 8px 0 0 #ffffff, 10px 8px 0 0 #ffffff, 11px 8px 0 0 #ffffff, 12px 8px 0 0 #ffffff, 13px 8px 0 0 #ffffff, 14px 8px 0 0 #303f46, 15px 8px 0 0 #303f46, 16px 8px 0 0 #303f46, 1px 9px 0 0 #303f46, 2px 9px 0 0 #303f46, 3px 9px 0 0 #303f46, 4px 9px 0 0 #303f46, 5px 9px 0 0 #303f46, 6px 9px 0 0 #303f46, 7px 9px 0 0 #ffffff, 8px 9px 0 0 #ffffff, 9px 9px 0 0 #ffffff, 10px 9px 0 0 #ffffff, 11px 9px 0 0 #ffffff, 12px 9px 0 0 #ffffff, 13px 9px 0 0 #303f46, 14px 9px 0 0 #303f46, 15px 9px 0 0 #303f46, 16px 9px 0 0 #303f46, 1px 10px 0 0 #303f46, 2px 10px 0 0 #303f46, 3px 10px 0 0 #303f46, 4px 10px 0 0 #303f46, 5px 10px 0 0 #303f46, 6px 10px 0 0 #303f46, 7px 10px 0 0 #303f46, 8px 10px 0 0 #ffffff, 9px 10px 0 0 #ffffff, 10px 10px 0 0 #ffffff, 11px 10px 0 0 #ffffff, 12px 10px 0 0 #303f46, 13px 10px 0 0 #303f46, 14px 10px 0 0 #ffffff, 15px 10px 0 0 #303f46, 16px 10px 0 0 #303f46, 1px 11px 0 0 #303f46, 2px 11px 0 0 #303f46, 3px 11px 0 0 #303f46, 4px 11px 0 0 #303f46, 5px 11px 0 0 #303f46, 6px 11px 0 0 #303f46, 7px 11px 0 0 #303f46, 8px 11px 0 0 #ffffff, 9px 11px 0 0 #ffffff, 10px 11px 0 0 #ffffff, 11px 11px 0 0 #ffffff, 12px 11px 0 0 #303f46, 13px 11px 0 0 #303f46, 14px 11px 0 0 #303f46, 15px 11px 0 0 #ffffff, 16px 11px 0 0 #303f46, 1px 12px 0 0 #303f46, 2px 12px 0 0 #303f46, 3px 12px 0 0 #303f46, 4px 12px 0 0 #303f46, 5px 12px 0 0 #303f46, 6px 12px 0 0 #303f46, 7px 12px 0 0 #ffffff, 8px 12px 0 0 #ffffff, 9px 12px 0 0 #ffffff, 10px 12px 0 0 #ffffff, 11px 12px 0 0 #ffffff, 12px 12px 0 0 #ffffff, 13px 12px 0 0 #303f46, 14px 12px 0 0 #303f46, 15px 12px 0 0 #ffffff, 16px 12px 0 0 #303f46, 1px 13px 0 0 #303f46, 2px 13px 0 0 #303f46, 3px 13px 0 0 #303f46, 4px 13px 0 0 #303f46, 5px 13px 0 0 #ffffff, 6px 13px 0 0 #ffffff, 7px 13px 0 0 #ffffff, 8px 13px 0 0 #ffffff, 9px 13px 0 0 #ffffff, 10px 13px 0 0 #ffffff, 11px 13px 0 0 #ffffff, 12px 13px 0 0 #ffffff, 13px 13px 0 0 #303f46, 14px 13px 0 0 #303f46, 15px 13px 0 0 #ffffff, 16px 13px 0 0 #303f46, 1px 14px 0 0 #303f46, 2px 14px 0 0 #303f46, 3px 14px 0 0 #303f46, 4px 14px 0 0 #303f46, 5px 14px 0 0 #ffffff, 6px 14px 0 0 #ffffff, 7px 14px 0 0 #ffffff, 8px 14px 0 0 #ffffff, 9px 14px 0 0 #ffffff, 10px 14px 0 0 #ffffff, 11px 14px 0 0 #ffffff, 12px 14px 0 0 #ffffff, 13px 14px 0 0 #303f46, 14px 14px 0 0 #ffffff, 15px 14px 0 0 #ffffff, 16px 14px 0 0 #303f46, 1px 15px 0 0 #303f46, 2px 15px 0 0 #303f46, 3px 15px 0 0 #303f46, 4px 15px 0 0 #ffffff, 5px 15px 0 0 #ffffff, 6px 15px 0 0 #ffffff, 7px 15px 0 0 #ffffff, 8px 15px 0 0 #ffffff, 9px 15px 0 0 #ffffff, 10px 15px 0 0 #ffffff, 11px 15px 0 0 #ffffff, 12px 15px 0 0 #ffffff, 13px 15px 0 0 #ffffff, 14px 15px 0 0 #ffffff, 15px 15px 0 0 #303f46, 16px 15px 0 0 #303f46, 1px 16px 0 0 #607d8b, 2px 16px 0 0 #607d8b, 3px 16px 0 0 #607d8b, 4px 16px 0 0 #607d8b, 5px 16px 0 0 #607d8b, 6px 16px 0 0 #ffffff, 7px 16px 0 0 #ffffff, 8px 16px 0 0 #607d8b, 9px 16px 0 0 #607d8b, 10px 16px 0 0 #607d8b, 11px 16px 0 0 #ffffff, 12px 16px 0 0 #ffffff, 13px 16px 0 0 #607d8b, 14px 16px 0 0 #607d8b, 15px 16px 0 0 #607d8b, 16px 16px 0 0 #607d8b;height: 1px; width: 1px;
  }
...
.nes-taylor {
            box-shadow: 1px 1px 0 0 #303f46, 2px 1px 0 0 #303f46, 3px 1px 0 0 #303f46, 4px 1px 0 0 #303f46, 5px 1px 0 0 #303f46, 6px 1px 0 0 #303f46, 7px 1px 0 0 #ffffff, 8px 1px 0 0 #303f46, 9px 1px 0 0 #303f46, 10px 1px 0 0 #303f46, 11px 1px 0 0 #303f46, 12px 1px 0 0 #ffffff, 13px 1px 0 0 #303f46, 14px 1px 0 0 #303f46, 15px 1px 0 0 #303f46, 16px 1px 0 0 #303f46, 1px 2px 0 0 #303f46, 2px 2px 0 0 #303f46, 3px 2px 0 0 #303f46, 4px 2px 0 0 #303f46, 5px 2px 0 0 #303f46, 6px 2px 0 0 #ffffff, 7px 2px 0 0 #ffcdd2, 8px 2px 0 0 #ffffff, 9px 2px 0 0 #303f46, 10px 2px 0 0 #303f46, 11px 2px 0 0 #ffffff, 12px 2px 0 0 #ffcdd2, 13px 2px 0 0 #ffffff, 14px 2px 0 0 #303f46, 15px 2px 0 0 #303f46, 16px 2px 0 0 #303f46, 1px 3px 0 0 #303f46, 2px 3px 0 0 #303f46, 3px 3px 0 0 #303f46, 4px 3px 0 0 #303f46, 5px 3px 0 0 #303f46, 6px 3px 0 0 #ffffff, 7px 3px 0 0 #ffcdd2, 8px 3px 0 0 #ffcdd2, 9px 3px 0 0 #ffffff, 10px 3px 0 0 #ffffff, 11px 3px 0 0 #ffcdd2, 12px 3px 0 0 #ffcdd2, 13px 3px 0 0 #ffffff, 14px 3px 0 0 #303f46, 15px 3px 0 0 #303f46, 16px 3px 0 0 #303f46, 1px 4px 0 0 #303f46, 2px 4px 0 0 #303f46, 3px 4px 0 0 #303f46, 4px 4px 0 0 #303f46, 5px 4px 0 0 #303f46, 6px 4px 0 0 #ffffff, 7px 4px 0 0 #ffcdd2, 8px 4px 0 0 #ffffff, 9px 4px 0 0 #ffffff, 10px 4px 0 0 #ffffff, 11px 4px 0 0 #ffffff, 12px 4px 0 0 #ffcdd2, 13px 4px 0 0 #ffffff, 14px 4px 0 0 #303f46, 15px 4px 0 0 #303f46, 16px 4px 0 0 #303f46, 1px 5px 0 0 #303f46, 2px 5px 0 0 #303f46, 3px 5px 0 0 #303f46, 4px 5px 0 0 #303f46, 5px 5px 0 0 #303f46, 6px 5px 0 0 #ffffff, 7px 5px 0 0 #ffffff, 8px 5px 0 0 #ffffff, 9px 5px 0 0 #ffffff, 10px 5px 0 0 #ffffff, 11px 5px 0 0 #ffffff, 12px 5px 0 0 #ffffff, 13px 5px 0 0 #ffffff, 14px 5px 0 0 #303f46, 15px 5px 0 0 #303f46, 16px 5px 0 0 #303f46, 1px 6px 0 0 #303f46, 2px 6px 0 0 #303f46, 3px 6px 0 0 #303f46, 4px 6px 0 0 #303f46, 5px 6px 0 0 #303f46, 6px 6px 0 0 #ffffff, 7px 6px 0 0 #000000, 8px 6px 0 0 #ffffff, 9px 6px 0 0 #ffffff, 10px 6px 0 0 #000000, 11px 6px 0 0 #ffffff, 12px 6px 0 0 #ffffff, 13px 6px 0 0 #ffffff, 14px 6px 0 0 #303f46, 15px 6px 0 0 #303f46, 16px 6px 0 0 #303f46, 1px 7px 0 0 #303f46, 2px 7px 0 0 #303f46, 3px 7px 0 0 #303f46, 4px 7px 0 0 #303f46, 5px 7px 0 0 #303f46, 6px 7px 0 0 #ffffff, 7px 7px 0 0 #ffffff, 8px 7px 0 0 #000000, 9px 7px 0 0 #ffffff, 10px 7px 0 0 #ffffff, 11px 7px 0 0 #ffffff, 12px 7px 0 0 #ffffff, 13px 7px 0 0 #ffffff, 14px 7px 0 0 #303f46, 15px 7px 0 0 #303f46, 16px 7px 0 0 #303f46, 1px 8px 0 0 #303f46, 2px 8px 0 0 #303f46, 3px 8px 0 0 #303f46, 4px 8px 0 0 #303f46, 5px 8px 0 0 #303f46, 6px 8px 0 0 #ffffff, 7px 8px 0 0 #ffffff, 8px 8px 0 0 #ffffff, 9px 8px 0 0 #ffffff, 10px 8px 0 0 #ffffff, 11px 8px 0 0 #ffffff, 12px 8px 0 0 #ffffff, 13px 8px 0 0 #ffffff, 14px 8px 0 0 #303f46, 15px 8px 0 0 #303f46, 16px 8px 0 0 #303f46, 1px 9px 0 0 #303f46, 2px 9px 0 0 #303f46, 3px 9px 0 0 #303f46, 4px 9px 0 0 #303f46, 5px 9px 0 0 #303f46, 6px 9px 0 0 #303f46, 7px 9px 0 0 #ffffff, 8px 9px 0 0 #ffffff, 9px 9px 0 0 #ffffff, 10px 9px 0 0 #ffffff, 11px 9px 0 0 #ffffff, 12px 9px 0 0 #ffffff, 13px 9px 0 0 #303f46, 14px 9px 0 0 #303f46, 15px 9px 0 0 #303f46, 16px 9px 0 0 #303f46, 1px 10px 0 0 #303f46, 2px 10px 0 0 #303f46, 3px 10px 0 0 #303f46, 4px 10px 0 0 #303f46, 5px 10px 0 0 #303f46, 6px 10px 0 0 #303f46, 7px 10px 0 0 #303f46, 8px 10px 0 0 #ffffff, 9px 10px 0 0 #ffffff, 10px 10px 0 0 #ffffff, 11px 10px 0 0 #ffffff, 12px 10px 0 0 #303f46, 13px 10px 0 0 #303f46, 14px 10px 0 0 #ffffff, 15px 10px 0 0 #303f46, 16px 10px 0 0 #303f46, 1px 11px 0 0 #303f46, 2px 11px 0 0 #303f46, 3px 11px 0 0 #303f46, 4px 11px 0 0 #303f46, 5px 11px 0 0 #303f46, 6px 11px 0 0 #303f46, 7px 11px 0 0 #303f46, 8px 11px 0 0 #ffffff, 9px 11px 0 0 #ffffff, 10px 11px 0 0 #ffffff, 11px 11px 0 0 #ffffff, 12px 11px 0 0 #303f46, 13px 11px 0 0 #303f46, 14px 11px 0 0 #303f46, 15px 11px 0 0 #ffffff, 16px 11px 0 0 #303f46, 1px 12px 0 0 #303f46, 2px 12px 0 0 #303f46, 3px 12px 0 0 #303f46, 4px 12px 0 0 #303f46, 5px 12px 0 0 #303f46, 6px 12px 0 0 #303f46, 7px 12px 0 0 #ffffff, 8px 12px 0 0 #ffffff, 9px 12px 0 0 #ffffff, 10px 12px 0 0 #ffffff, 11px 12px 0 0 #ffffff, 12px 12px 0 0 #ffffff, 13px 12px 0 0 #303f46, 14px 12px 0 0 #303f46, 15px 12px 0 0 #ffffff, 16px 12px 0 0 #303f46, 1px 13px 0 0 #303f46, 2px 13px 0 0 #303f46, 3px 13px 0 0 #303f46, 4px 13px 0 0 #303f46, 5px 13px 0 0 #ffffff, 6px 13px 0 0 #ffffff, 7px 13px 0 0 #ffffff, 8px 13px 0 0 #ffffff, 9px 13px 0 0 #ffffff, 10px 13px 0 0 #ffffff, 11px 13px 0 0 #ffffff, 12px 13px 0 0 #ffffff, 13px 13px 0 0 #303f46, 14px 13px 0 0 #303f46, 15px 13px 0 0 #ffffff, 16px 13px 0 0 #303f46, 1px 14px 0 0 #303f46, 2px 14px 0 0 #303f46, 3px 14px 0 0 #303f46, 4px 14px 0 0 #303f46, 5px 14px 0 0 #ffffff, 6px 14px 0 0 #ffffff, 7px 14px 0 0 #ffffff, 8px 14px 0 0 #ffffff, 9px 14px 0 0 #ffffff, 10px 14px 0 0 #ffffff, 11px 14px 0 0 #ffffff, 12px 14px 0 0 #ffffff, 13px 14px 0 0 #303f46, 14px 14px 0 0 #ffffff, 15px 14px 0 0 #ffffff, 16px 14px 0 0 #303f46, 1px 15px 0 0 #303f46, 2px 15px 0 0 #303f46, 3px 15px 0 0 #303f46, 4px 15px 0 0 #ffffff, 5px 15px 0 0 #ffffff, 6px 15px 0 0 #ffffff, 7px 15px 0 0 #ffffff, 8px 15px 0 0 #ffffff, 9px 15px 0 0 #ffffff, 10px 15px 0 0 #ffffff, 11px 15px 0 0 #ffffff, 12px 15px 0 0 #ffffff, 13px 15px 0 0 #ffffff, 14px 15px 0 0 #ffffff, 15px 15px 0 0 #303f46, 16px 15px 0 0 #303f46, 1px 16px 0 0 #607d8b, 2px 16px 0 0 #607d8b, 3px 16px 0 0 #607d8b, 4px 16px 0 0 #607d8b, 5px 16px 0 0 #607d8b, 6px 16px 0 0 #ffffff, 7px 16px 0 0 #ffffff, 8px 16px 0 0 #607d8b, 9px 16px 0 0 #607d8b, 10px 16px 0 0 #607d8b, 11px 16px 0 0 #ffffff, 12px 16px 0 0 #ffffff, 13px 16px 0 0 #607d8b, 14px 16px 0 0 #607d8b, 15px 16px 0 0 #607d8b, 16px 16px 0 0 #607d8b;  display:inline-block;
            height: 1px;
            width: 1px;
            position:absolute;
            top:0;
...
/* .nes-taylor::before {
  ...
  height: 6px;
  color: #f81c2f;
  box-shadow: 1px 1px 0 0 rgba(27,32,60,255), 2px 1px 0 0 rgba(28,34,62,255), 3px 1px 0 0 rgba(29,35,62,255), 4px 1px 0 0 rgba(27,33,62,255), 5px 1px 0 0 rgba(42,42,64,255), 6px 1px 0 0 rgba(58,39,33,255), 7px 1px 0 0 rgba(87,65,55,255), 8px 1px 0 0 rgba(119,94,75,255), 9px 1px 0 0 rgba(154,122,102,255), 10px 1px 0 0 rgba(181,150,134,255), 11px 1px 0 0 rgba(142,111,92,255), 12px 1px 0 0 rgba(98,66,45,255), 13px 1px 0 0 rgba(98,63,41,255), 14px 1px 0 0 rgba(85,53,37,255), 15px 1px 0 0 rgba(53,27,19,255), 16px 1px 0 0 rgba(127,80,62,255), 17px 1px 0 0 rgba(119,83,62,255), 18px 1px 0 0 rgba(98,78,64,255), 19px 1px 0 0 rgba(59,57,69,255), 20px 1px 0 0 rgba(33,39,68,255), 21px 1px 0 0 rgba(38,44,71,255), 22px 1px 0 0 rgba(34,41,69,255), 23px 1px 0 0 rgba(34,41,69,255), 24px 1px 0 0 rgba(33,40,68,255), 25px 1px 0 0 rgba(33,38,68,255), 1px 2px 0 0 rgba(26,32,60,255), 2px 2px 0 0 rgba(27,34,61,255), 3px 2px 0 0 rgba(30,35,62,255), 4px 2px 0 0 rgba(26,33,63,255), 5px 2px 0 0 rgba(52,49,63,255), 6px 2px 0 0 rgba(73,49,37,255), 7px 2px 0 0 rgba(104,77,63,255), 8px 2px 0 0 rgba(144,119,102,255), 9px 2px 0 0 rgba(172,147,126,255), 10px 2px 0 0 rgba(201,165,145,255), 11px 2px 0 0 rgba(189,146,121,255), 12px 2px 0 0 rgba(143,101,75,255), 13px 2px 0 0 rgba(87,52,39,255), 14px 2px 0 0 rgba(58,34,29,255), 15px 2px 0 0 rgba(126,95,82,255), 16px 2px 0 0 rgba(180,130,113,255), 17px 2px 0 0 rgba(139,99,78,255), 18px 2px 0 0 rgba(113,91,75,255), 19px 2px 0 0 rgba(124,107,90,255), 20px 2px 0 0 rgba(47,51,74,255), 21px 2px 0 0 rgba(33,40,67,255), 22px 2px 0 0 rgba(36,42,70,255), 23px 2px 0 0 rgba(35,41,70,255), 24px 2px 0 0 rgba(33,40,68,255), 25px 2px 0 0 rgba(32,39,67,255), 1px 3px 0 0 rgba(26,33,60,255), 2px 3px 0 0 rgba(28,34,61,255), 3px 3px 0 0 rgba(30,34,62,255), 4px 3px 0 0 rgba(27,34,63,255), 5px 3px 0 0 rgba(65,57,62,255), 6px 3px 0 0 rgba(97,69,51,255), 7px 3px 0 0 rgba(133,97,76,255), 8px 3px 0 0 rgba(159,129,112,255), 9px 3px 0 0 rgba(169,147,131,255), 10px 3px 0 0 rgba(166,134,111,255), 11px 3px 0 0 rgba(195,150,124,255), 12px 3px 0 0 rgba(204,158,132,255), 13px 3px 0 0 rgba(185,143,123,255), 14px 3px 0 0 rgba(123,94,82,255), 15px 3px 0 0 rgba(116,84,70,255), 16px 3px 0 0 rgba(181,139,123,255), 17px 3px 0 0 rgba(166,124,105,255), 18px 3px 0 0 rgba(119,95,81,255), 19px 3px 0 0 rgba(132,110,90,255), 20px 3px 0 0 rgba(97,92,96,255), 21px 3px 0 0 rgba(27,34,63,255), 22px 3px 0 0 rgba(37,43,71,255), 23px 3px 0 0 rgba(35,42,70,255), 24px 3px 0 0 rgba(33,41,68,255), 25px 3px 0 0 rgba(32,40,68,255), 1px 4px 0 0 rgba(27,33,61,255), 2px 4px 0 0 rgba(29,34,62,255), 3px 4px 0 0 rgba(30,35,62,255), 4px 4px 0 0 rgba(28,35,64,255), 5px 4px 0 0 rgba(82,69,67,255), 6px 4px 0 0 rgba(125,95,71,255), 7px 4px 0 0 rgba(165,126,102,255), 8px 4px 0 0 rgba(179,148,130,255), 9px 4px 0 0 rgba(166,135,117,255), 10px 4px 0 0 rgba(149,112,85,255), 11px 4px 0 0 rgba(140,100,71,255), 12px 4px 0 0 rgba(160,112,82,255), 13px 4px 0 0 rgba(201,153,128,255), 14px 4px 0 0 rgba(160,119,99,255), 15px 4px 0 0 rgba(88,51,37,255), 16px 4px 0 0 rgba(117,80,64,255), 17px 4px 0 0 rgba(144,104,85,255), 18px 4px 0 0 rgba(141,114,95,255), 19px 4px 0 0 rgba(122,101,84,255), 20px 4px 0 0 rgba(118,104,93,255), 21px 4px 0 0 rgba(33,39,66,255), 22px 4px 0 0 rgba(35,42,70,255), 23px 4px 0 0 rgba(35,42,69,255), 24px 4px 0 0 rgba(34,41,68,255), 25px 4px 0 0 rgba(33,40,68,255), 1px 5px 0 0 rgba(28,34,61,255), 2px 5px 0 0 rgba(30,35,62,255), 3px 5px 0 0 rgba(31,35,63,255), 4px 5px 0 0 rgba(29,35,63,255), 5px 5px 0 0 rgba(106,88,81,255), 6px 5px 0 0 rgba(161,134,112,255), 7px 5px 0 0 rgba(183,150,129,255), 8px 5px 0 0 rgba(191,157,138,255), 9px 5px 0 0 rgba(169,134,113,255), 10px 5px 0 0 rgba(166,130,106,255), 11px 5px 0 0 rgba(169,128,104,255), 12px 5px 0 0 rgba(162,115,90,255), 13px 5px 0 0 rgba(205,157,134,255), 14px 5px 0 0 rgba(195,144,122,255), 15px 5px 0 0 rgba(130,81,59,255), 16px 5px 0 0 rgba(125,82,62,255), 17px 5px 0 0 rgba(131,97,79,255), 18px 5px 0 0 rgba(135,106,87,255), 19px 5px 0 0 rgba(148,128,110,255), 20px 5px 0 0 rgba(136,120,105,255), 21px 5px 0 0 rgba(51,52,71,255), 22px 5px 0 0 rgba(32,39,68,255), 23px 5px 0 0 rgba(36,43,70,255), 24px 5px 0 0 rgba(34,42,69,255), 25px 5px 0 0 rgba(34,41,69,255), 1px 6px 0 0 rgba(29,34,61,255), 2px 6px 0 0 rgba(29,35,62,255), 3px 6px 0 0 rgba(30,36,64,255), 4px 6px 0 0 rgba(29,34,61,255), 5px 6px 0 0 rgba(126,108,99,255), 6px 6px 0 0 rgba(168,144,125,255), 7px 6px 0 0 rgba(175,147,129,255), 8px 6px 0 0 rgba(189,152,129,255), 9px 6px 0 0 rgba(178,137,112,255), 10px 6px 0 0 rgba(146,109,87,255), 11px 6px 0 0 rgba(0, 0, 0, 1), 12px 6px 0 0 rgba(176,133,116,255), 13px 6px 0 0 rgba(224,177,155,255), 14px 6px 0 0 rgba(188,134,114,255), 15px 6px 0 0 rgba(170,115,93,255), 16px 6px 0 0 rgba(195,142,117,255), 17px 6px 0 0 rgba(179,133,113,255), 18px 6px 0 0 rgba(144,114,95,255), 19px 6px 0 0 rgba(169,145,119,255), 20px 6px 0 0 rgba(170,155,137,255), 21px 6px 0 0 rgba(81,75,79,255), 22px 6px 0 0 rgba(36,41,66,255), 23px 6px 0 0 rgba(38,45,71,255), 24px 6px 0 0 rgba(35,42,69,255), 25px 6px 0 0 rgba(35,41,69,255), 1px 7px 0 0 rgba(28,35,62,255), 2px 7px 0 0 rgba(30,36,63,255), 3px 7px 0 0 rgba(31,37,63,255), 4px 7px 0 0 rgba(28,33,59,255), 5px 7px 0 0 rgba(134,119,112,255), 6px 7px 0 0 rgba(153,128,109,255), 7px 7px 0 0 rgba(153,116,91,255), 8px 7px 0 0 rgba(181,142,117,255), 9px 7px 0 0 rgba(158,111,87,255), 10px 7px 0 0 rgba(0, 0, 0, 1), 11px 7px 0 0 rgba(63, 81, 181, 1), 12px 7px 0 0 rgba(216,174,156,255), 13px 7px 0 0 rgba(224,176,155,255), 14px 7px 0 0 rgba(185,129,109,255), 15px 7px 0 0 rgba(170,116,94,255), 16px 7px 0 0 rgba(214,163,139,255), 17px 7px 0 0 rgba(133,99,87,255), 18px 7px 0 0 rgba(142,114,93,255), 19px 7px 0 0 rgba(174,147,116,255), 20px 7px 0 0 rgba(188,170,146,255), 21px 7px 0 0 rgba(116,102,94,255), 22px 7px 0 0 rgba(47,46,64,255), 23px 7px 0 0 rgba(35,43,69,255), 24px 7px 0 0 rgba(36,42,69,255), 25px 7px 0 0 rgba(37,43,70,255), 1px 8px 0 0 rgba(29,35,62,255), 2px 8px 0 0 rgba(30,36,63,255), 3px 8px 0 0 rgba(33,39,65,255), 4px 8px 0 0 rgba(24,30,59,255), 5px 8px 0 0 rgba(127,113,109,255), 6px 8px 0 0 rgba(145,116,93,255), 7px 8px 0 0 rgba(140,104,81,255), 8px 8px 0 0 rgba(192,150,126,255), 9px 8px 0 0 rgba(170,120,98,255), 10px 8px 0 0 rgba(143,105,97,255), 11px 8px 0 0 rgba(184,155,148,255), 12px 8px 0 0 rgba(234,190,168,255), 13px 8px 0 0 rgba(220,170,150,255), 14px 8px 0 0 rgba(186,132,111,255), 15px 8px 0 0 rgba(185,133,110,255), 16px 8px 0 0 rgba(152,100,80,255), 17px 8px 0 0 rgba(45,26,22,255), 18px 8px 0 0 rgba(157,132,111,255), 19px 8px 0 0 rgba(176,147,117,255), 20px 8px 0 0 rgba(176,152,124,255), 21px 8px 0 0 rgba(165,145,125,255), 22px 8px 0 0 rgba(70,61,67,255), 23px 8px 0 0 rgba(38,43,69,255), 24px 8px 0 0 rgba(34,40,67,255), 25px 8px 0 0 rgba(54,58,87,255), 1px 9px 0 0 rgba(30,35,62,255), 2px 9px 0 0 rgba(30,37,64,255), 3px 9px 0 0 rgba(33,38,65,255), 4px 9px 0 0 rgba(24,30,59,255), 5px 9px 0 0 rgba(91,82,86,255), 6px 9px 0 0 rgba(154,124,102,255), 7px 9px 0 0 rgba(134,96,73,255), 8px 9px 0 0 rgba(200,152,129,255), 9px 9px 0 0 rgba(223,179,160,255), 10px 9px 0 0 rgba(192,151,135,255), 11px 9px 0 0 rgba(213,170,152,255), 12px 9px 0 0 rgba(238,191,171,255), 13px 9px 0 0 rgba(214,159,140,255), 14px 9px 0 0 rgba(192,136,115,255), 15px 9px 0 0 rgba(195,145,123,255), 16px 9px 0 0 rgba(153,101,76,255), 17px 9px 0 0 rgba(89,57,42,255), 18px 9px 0 0 rgba(156,132,108,255), 19px 9px 0 0 rgba(190,163,133,255), 20px 9px 0 0 rgba(152,123,89,255), 21px 9px 0 0 rgba(160,132,102,255), 22px 9px 0 0 rgba(107,88,79,255), 23px 9px 0 0 rgba(41,44,68,255), 24px 9px 0 0 rgba(34,39,66,255), 25px 9px 0 0 rgba(83,87,117,255), 1px 10px 0 0 rgba(30,35,63,255), 2px 10px 0 0 rgba(31,37,64,255), 3px 10px 0 0 rgba(33,38,65,255), 4px 10px 0 0 rgba(26,33,62,255), 5px 10px 0 0 rgba(58,55,70,255), 6px 10px 0 0 rgba(128,99,82,255), 7px 10px 0 0 rgba(123,85,64,255), 8px 10px 0 0 rgba(0, 0, 0, 1), 9px 10px 0 0 rgba(229,189,171,255), 10px 10px 0 0 rgba(230,191,174,255), 11px 10px 0 0 rgba(237,194,175,255), 12px 10px 0 0 rgba(232,179,161,255), 13px 10px 0 0 rgba(208,150,131,255), 14px 10px 0 0 rgba(197,140,119,255), 15px 10px 0 0 rgba(203,151,128,255), 16px 10px 0 0 rgba(167,115,90,255), 17px 10px 0 0 rgba(110,69,49,255), 18px 10px 0 0 rgba(149,124,98,255), 19px 10px 0 0 rgba(192,165,135,255), 20px 10px 0 0 rgba(157,124,86,255), 21px 10px 0 0 rgba(132,101,69,255), 22px 10px 0 0 rgba(124,96,72,255), 23px 10px 0 0 rgba(52,50,65,255), 24px 10px 0 0 rgba(40,45,70,255), 25px 10px 0 0 rgba(112,116,148,255), 1px 11px 0 0 rgba(29,35,62,255), 2px 11px 0 0 rgba(31,36,64,255), 3px 11px 0 0 rgba(32,37,64,255), 4px 11px 0 0 rgba(31,37,63,255), 5px 11px 0 0 rgba(34,38,62,255), 6px 11px 0 0 rgba(104,75,61,255), 7px 11px 0 0 rgba(0, 0, 0, 1), 8px 11px 0 0 rgba(63, 81, 181, 1), 9px 11px 0 0 rgba(213,174,159,255), 10px 11px 0 0 rgba(230,183,162,255), 11px 11px 0 0 rgba(240,196,176,255), 12px 11px 0 0 rgba(230,176,157,255), 13px 11px 0 0 rgba(206,148,127,255), 14px 11px 0 0 rgba(204,147,126,255), 15px 11px 0 0 rgba(207,153,133,255), 16px 11px 0 0 rgba(170,116,91,255), 17px 11px 0 0 rgba(117,71,48,255), 18px 11px 0 0 rgba(144,120,96,255), 19px 11px 0 0 rgba(187,159,128,255), 20px 11px 0 0 rgba(153,116,76,255), 21px 11px 0 0 rgba(144,115,82,255), 22px 11px 0 0 rgba(135,105,75,255), 23px 11px 0 0 rgba(70,57,57,255), 24px 11px 0 0 rgba(49,53,78,255), 25px 11px 0 0 rgba(133,137,169,255), 1px 12px 0 0 rgba(29,35,62,255), 2px 12px 0 0 rgba(30,36,63,255), 3px 12px 0 0 rgba(32,37,64,255), 4px 12px 0 0 rgba(33,38,64,255), 5px 12px 0 0 rgba(28,34,64,255), 6px 12px 0 0 rgba(73,59,66,255), 7px 12px 0 0 rgba(71,48,42,255), 8px 12px 0 0 rgba(132,108,106,255), 9px 12px 0 0 rgba(235,189,169,255), 10px 12px 0 0 rgba(213,167,149,255), 11px 12px 0 0 rgba(225,177,156,255), 12px 12px 0 0 rgba(229,175,154,255), 13px 12px 0 0 rgba(213,157,135,255), 14px 12px 0 0 rgba(213,158,136,255), 15px 12px 0 0 rgba(209,154,135,255), 16px 12px 0 0 rgba(164,108,83,255), 17px 12px 0 0 rgba(129,76,49,255), 18px 12px 0 0 rgba(144,116,92,255), 19px 12px 0 0 rgba(177,151,119,255), 20px 12px 0 0 rgba(144,107,70,255), 21px 12px 0 0 rgba(158,128,92,255), 22px 12px 0 0 rgba(151,123,92,255), 23px 12px 0 0 rgba(79,60,51,255), 24px 12px 0 0 rgba(60,59,79,255), 25px 12px 0 0 rgba(144,149,182,255), 1px 13px 0 0 rgba(31,37,64,255), 2px 13px 0 0 rgba(31,36,64,255), 3px 13px 0 0 rgba(32,37,64,255), 4px 13px 0 0 rgba(33,38,64,255), 5px 13px 0 0 rgba(34,38,65,255), 6px 13px 0 0 rgba(33,37,65,255), 7px 13px 0 0 rgba(66,55,63,255), 8px 13px 0 0 rgba(147,116,105,255), 9px 13px 0 0 rgba(243,197,179,255), 10px 13px 0 0 rgba(199,146,133,255), 11px 13px 0 0 rgba(194,141,123,255), 12px 13px 0 0 rgba(235,186,164,255), 13px 13px 0 0 rgba(217,165,140,255), 14px 13px 0 0 rgba(216,163,138,255), 15px 13px 0 0 rgba(208,155,133,255), 16px 13px 0 0 rgba(146,88,61,255), 17px 13px 0 0 rgba(138,82,51,255), 18px 13px 0 0 rgba(159,127,96,255), 19px 13px 0 0 rgba(184,157,126,255), 20px 13px 0 0 rgba(149,117,84,255), 21px 13px 0 0 rgba(175,147,111,255), 22px 13px 0 0 rgba(177,152,121,255), 23px 13px 0 0 rgba(93,72,59,255), 24px 13px 0 0 rgba(66,60,74,255), 25px 13px 0 0 rgba(147,151,183,255), 1px 14px 0 0 rgba(31,37,66,255), 2px 14px 0 0 rgba(33,38,67,255), 3px 14px 0 0 rgba(32,37,64,255), 4px 14px 0 0 rgba(33,38,65,255), 5px 14px 0 0 rgba(33,38,65,255), 6px 14px 0 0 rgba(35,40,65,255), 7px 14px 0 0 rgba(25,31,58,255), 8px 14px 0 0 rgba(94,79,84,255), 9px 14px 0 0 rgba(227,179,159,255), 10px 14px 0 0 rgba(160,103,93,255), 11px 14px 0 0 rgba(223,177,159,255), 12px 14px 0 0 rgba(218,166,144,255), 13px 14px 0 0 rgba(199,146,122,255), 14px 14px 0 0 rgba(218,164,138,255), 15px 14px 0 0 rgba(202,149,126,255), 16px 14px 0 0 rgba(125,65,34,255), 17px 14px 0 0 rgba(149,92,61,255), 18px 14px 0 0 rgba(190,155,124,255), 19px 14px 0 0 rgba(194,166,133,255), 20px 14px 0 0 rgba(167,137,106,255), 21px 14px 0 0 rgba(181,157,126,255), 22px 14px 0 0 rgba(187,162,127,255), 23px 14px 0 0 rgba(96,77,66,255), 24px 14px 0 0 rgba(70,64,78,255), 25px 14px 0 0 rgba(141,144,171,255), 1px 15px 0 0 rgba(33,37,66,255), 2px 15px 0 0 rgba(37,41,70,255), 3px 15px 0 0 rgba(32,37,64,255), 4px 15px 0 0 rgba(33,38,65,255), 5px 15px 0 0 rgba(34,38,65,255), 6px 15px 0 0 rgba(36,40,66,255), 7px 15px 0 0 rgba(35,39,65,255), 8px 15px 0 0 rgba(27,33,59,255), 9px 15px 0 0 rgba(166,127,117,255), 10px 15px 0 0 rgba(203,154,133,255), 11px 15px 0 0 rgba(221,165,150,255), 12px 15px 0 0 rgba(255, 0, 0, 1), 13px 15px 0 0 rgba(210,155,136,255), 14px 15px 0 0 rgba(218,168,139,255), 15px 15px 0 0 rgba(190,135,110,255), 16px 15px 0 0 rgba(111,48,14,255), 17px 15px 0 0 rgba(161,104,74,255), 18px 15px 0 0 rgba(196,155,127,255), 19px 15px 0 0 rgba(202,177,145,255), 20px 15px 0 0 rgba(174,145,115,255), 21px 15px 0 0 rgba(187,162,132,255), 22px 15px 0 0 rgba(173,144,104,255), 23px 15px 0 0 rgba(104,82,66,255), 24px 15px 0 0 rgba(72,69,88,255), 25px 15px 0 0 rgba(130,132,157,255), 1px 16px 0 0 rgba(35,38,67,255), 2px 16px 0 0 rgba(49,44,78,255), 3px 16px 0 0 rgba(33,38,65,255), 4px 16px 0 0 rgba(33,39,65,255), 5px 16px 0 0 rgba(35,39,65,255), 6px 16px 0 0 rgba(36,40,66,255), 7px 16px 0 0 rgba(38,41,67,255), 8px 16px 0 0 rgba(26,33,60,255), 9px 16px 0 0 rgba(72,63,76,255), 10px 16px 0 0 rgba(210,160,140,255), 11px 16px 0 0 rgba(255, 0, 0, 1), 12px 16px 0 0 rgba(255, 0, 0, 1), 13px 16px 0 0 rgba(217,164,143,255), 14px 16px 0 0 rgba(222,173,149,255), 15px 16px 0 0 rgba(165,109,82,255), 16px 16px 0 0 rgba(103,37,3,255), 17px 16px 0 0 rgba(178,123,95,255), 18px 16px 0 0 rgba(180,133,106,255), 19px 16px 0 0 rgba(187,158,129,255), 20px 16px 0 0 rgba(173,145,115,255), 21px 16px 0 0 rgba(179,153,120,255), 22px 16px 0 0 rgba(154,123,83,255), 23px 16px 0 0 rgba(119,89,61,255), 24px 16px 0 0 rgba(82,74,85,255), 25px 16px 0 0 rgba(126,130,152,255), 1px 17px 0 0 rgba(39,38,68,255), 2px 17px 0 0 rgba(55,45,80,255), 3px 17px 0 0 rgba(34,38,65,255), 4px 17px 0 0 rgba(33,38,64,255), 5px 17px 0 0 rgba(35,39,65,255), 6px 17px 0 0 rgba(36,40,66,255), 7px 17px 0 0 rgba(36,40,66,255), 8px 17px 0 0 rgba(38,41,66,255), 9px 17px 0 0 rgba(30,33,59,255), 10px 17px 0 0 rgba(123,99,95,255), 11px 17px 0 0 rgba(255, 0, 0, 1), 12px 17px 0 0 rgba(255, 0, 0, 1), 13px 17px 0 0 rgba(226,181,157,255), 14px 17px 0 0 rgba(215,165,143,255), 15px 17px 0 0 rgba(132,70,40,255), 16px 17px 0 0 rgba(108,44,13,255), 17px 17px 0 0 rgba(191,136,109,255), 18px 17px 0 0 rgba(183,132,103,255), 19px 17px 0 0 rgba(177,140,109,255), 20px 17px 0 0 rgba(178,150,118,255), 21px 17px 0 0 rgba(173,145,111,255), 22px 17px 0 0 rgba(154,123,84,255), 23px 17px 0 0 rgba(126,94,61,255), 24px 17px 0 0 rgba(112,83,70,255), 25px 17px 0 0 rgba(128,114,120,255), 1px 18px 0 0 rgba(40,38,70,255), 2px 18px 0 0 rgba(58,47,85,255), 3px 18px 0 0 rgba(36,41,69,255), 4px 18px 0 0 rgba(32,38,65,255), 5px 18px 0 0 rgba(35,39,66,255), 6px 18px 0 0 rgba(37,40,66,255), 7px 18px 0 0 rgba(36,40,66,255), 8px 18px 0 0 rgba(37,41,67,255), 9px 18px 0 0 rgba(33,37,63,255), 10px 18px 0 0 rgba(59,57,72,255), 11px 18px 0 0 rgba(168,122,107,255), 12px 18px 0 0 rgba(203,147,124,255), 13px 18px 0 0 rgba(246,203,182,255), 14px 18px 0 0 rgba(187,131,105,255), 15px 18px 0 0 rgba(98,30,1,255), 16px 18px 0 0 rgba(119,58,29,255), 17px 18px 0 0 rgba(198,143,115,255), 18px 18px 0 0 rgba(189,137,108,255), 19px 18px 0 0 rgba(188,149,119,255), 20px 18px 0 0 rgba(180,151,120,255), 21px 18px 0 0 rgba(170,139,106,255), 22px 18px 0 0 rgba(166,137,99,255), 23px 18px 0 0 rgba(127,93,60,255), 24px 18px 0 0 rgba(140,102,80,255), 25px 18px 0 0 rgba(145,104,84,255), 1px 19px 0 0 rgba(43,42,76,255), 2px 19px 0 0 rgba(73,59,102,255), 3px 19px 0 0 rgba(47,46,78,255), 4px 19px 0 0 rgba(32,38,65,255), 5px 19px 0 0 rgba(36,40,66,255), 6px 19px 0 0 rgba(36,40,66,255), 7px 19px 0 0 rgba(37,41,68,255), 8px 19px 0 0 rgba(42,45,74,255), 9px 19px 0 0 rgba(37,41,68,255), 10px 19px 0 0 rgba(39,41,63,255), 11px 19px 0 0 rgba(67,59,66,255), 12px 19px 0 0 rgba(195,157,143,255), 13px 19px 0 0 rgba(237,179,153,255), 14px 19px 0 0 rgba(126,80,67,255), 15px 19px 0 0 rgba(98,39,15,255), 16px 19px 0 0 rgba(133,72,43,255), 17px 19px 0 0 rgba(201,148,119,255), 18px 19px 0 0 rgba(197,146,117,255), 19px 19px 0 0 rgba(188,145,116,255), 20px 19px 0 0 rgba(176,145,113,255), 21px 19px 0 0 rgba(180,151,117,255), 22px 19px 0 0 rgba(170,141,107,255), 23px 19px 0 0 rgba(130,98,68,255), 24px 19px 0 0 rgba(144,106,84,255), 25px 19px 0 0 rgba(103,85,67,255), 1px 20px 0 0 rgba(50,50,87,255), 2px 20px 0 0 rgba(77,65,108,255), 3px 20px 0 0 rgba(50,48,82,255), 4px 20px 0 0 rgba(37,41,70,255), 5px 20px 0 0 rgba(40,43,71,255), 6px 20px 0 0 rgba(36,40,67,255), 7px 20px 0 0 rgba(38,42,69,255), 8px 20px 0 0 rgba(46,49,81,255), 9px 20px 0 0 rgba(38,42,71,255), 10px 20px 0 0 rgba(43,47,70,255), 11px 20px 0 0 rgba(57,55,70,255), 12px 20px 0 0 rgba(70,59,68,255), 13px 20px 0 0 rgba(135,97,87,255), 14px 20px 0 0 rgba(35,35,59,255), 15px 20px 0 0 rgba(86,61,62,255), 16px 20px 0 0 rgba(153,95,66,255), 17px 20px 0 0 rgba(199,148,120,255), 18px 20px 0 0 rgba(211,161,132,255), 19px 20px 0 0 rgba(192,149,120,255), 20px 20px 0 0 rgba(177,144,109,255), 21px 20px 0 0 rgba(189,159,125,255), 22px 20px 0 0 rgba(183,154,120,255), 23px 20px 0 0 rgba(142,110,79,255), 24px 20px 0 0 rgba(140,107,81,255), 25px 20px 0 0 rgba(134,111,86,255), 1px 21px 0 0 rgba(58,53,92,255), 2px 21px 0 0 rgba(75,61,105,255), 3px 21px 0 0 rgba(57,53,92,255), 4px 21px 0 0 rgba(52,48,85,255), 5px 21px 0 0 rgba(47,46,80,255), 6px 21px 0 0 rgba(38,41,70,255), 7px 21px 0 0 rgba(41,45,73,255), 8px 21px 0 0 rgba(49,50,83,255), 9px 21px 0 0 rgba(40,44,71,255), 10px 21px 0 0 rgba(36,40,66,255), 11px 21px 0 0 rgba(69,67,83,255), 12px 21px 0 0 rgba(52,48,65,255), 13px 21px 0 0 rgba(27,32,59,255), 14px 21px 0 0 rgba(33,38,64,255), 15px 21px 0 0 rgba(47,45,64,255), 16px 21px 0 0 rgba(161,113,91,255), 17px 21px 0 0 rgba(207,159,133,255), 18px 21px 0 0 rgba(217,168,140,255), 19px 21px 0 0 rgba(204,161,134,255), 20px 21px 0 0 rgba(190,156,122,255), 21px 21px 0 0 rgba(191,161,124,255), 22px 21px 0 0 rgba(194,167,130,255), 23px 21px 0 0 rgba(160,126,92,255), 24px 21px 0 0 rgba(123,101,73,255), 25px 21px 0 0 rgba(144,121,94,255), 1px 22px 0 0 rgba(70,61,104,255), 2px 22px 0 0 rgba(79,65,110,255), 3px 22px 0 0 rgba(74,59,106,255), 4px 22px 0 0 rgba(69,56,102,255), 5px 22px 0 0 rgba(55,54,92,255), 6px 22px 0 0 rgba(40,43,74,255), 7px 22px 0 0 rgba(50,49,81,255), 8px 22px 0 0 rgba(54,50,85,255), 9px 22px 0 0 rgba(42,44,71,255), 10px 22px 0 0 rgba(50,51,82,255), 11px 22px 0 0 rgba(59,59,82,255), 12px 22px 0 0 rgba(75,70,82,255), 13px 22px 0 0 rgba(43,42,65,255), 14px 22px 0 0 rgba(34,37,63,255), 15px 22px 0 0 rgba(55,48,64,255), 16px 22px 0 0 rgba(176,133,110,255), 17px 22px 0 0 rgba(215,172,148,255), 18px 22px 0 0 rgba(217,169,142,255), 19px 22px 0 0 rgba(217,174,147,255), 20px 22px 0 0 rgba(190,153,120,255), 21px 22px 0 0 rgba(181,151,112,255), 22px 22px 0 0 rgba(197,168,128,255), 23px 22px 0 0 rgba(160,126,93,255), 24px 22px 0 0 rgba(96,84,55,255), 25px 22px 0 0 rgba(152,127,99,255), 1px 23px 0 0 rgba(98,87,137,255), 2px 23px 0 0 rgba(94,82,132,255), 3px 23px 0 0 rgba(76,59,110,255), 4px 23px 0 0 rgba(76,61,110,255), 5px 23px 0 0 rgba(67,64,103,255), 6px 23px 0 0 rgba(55,49,86,255), 7px 23px 0 0 rgba(65,56,96,255), 8px 23px 0 0 rgba(61,50,90,255), 9px 23px 0 0 rgba(43,43,73,255), 10px 23px 0 0 rgba(59,60,93,255), 11px 23px 0 0 rgba(45,47,75,255), 12px 23px 0 0 rgba(66,62,78,255), 13px 23px 0 0 rgba(55,53,72,255), 14px 23px 0 0 rgba(30,35,61,255), 15px 23px 0 0 rgba(140,113,107,255), 16px 23px 0 0 rgba(185,145,121,255), 17px 23px 0 0 rgba(221,179,158,255), 18px 23px 0 0 rgba(218,173,147,255), 19px 23px 0 0 rgba(224,182,158,255), 20px 23px 0 0 rgba(184,143,108,255), 21px 23px 0 0 rgba(154,118,78,255), 22px 23px 0 0 rgba(190,159,118,255), 23px 23px 0 0 rgba(156,122,88,255), 24px 23px 0 0 rgba(75,66,44,255), 25px 23px 0 0 rgba(162,138,112,255), 1px 24px 0 0 rgba(116,99,157,255), 2px 24px 0 0 rgba(111,94,153,255), 3px 24px 0 0 rgba(94,75,132,255), 4px 24px 0 0 rgba(84,70,120,255), 5px 24px 0 0 rgba(72,63,106,255), 6px 24px 0 0 rgba(69,57,101,255), 7px 24px 0 0 rgba(80,68,116,255), 8px 24px 0 0 rgba(66,55,96,255), 9px 24px 0 0 rgba(43,45,76,255), 10px 24px 0 0 rgba(46,50,82,255), 11px 24px 0 0 rgba(43,45,71,255), 12px 24px 0 0 rgba(50,48,70,255), 13px 24px 0 0 rgba(38,38,61,255), 14px 24px 0 0 rgba(103,87,94,255), 15px 24px 0 0 rgba(217,180,162,255), 16px 24px 0 0 rgba(199,165,147,255), 17px 24px 0 0 rgba(229,191,171,255), 18px 24px 0 0 rgba(221,179,156,255), 19px 24px 0 0 rgba(222,177,154,255), 20px 24px 0 0 rgba(164,117,78,255), 21px 24px 0 0 rgba(128,84,45,255), 22px 24px 0 0 rgba(181,146,102,255), 23px 24px 0 0 rgba(144,112,83,255), 24px 24px 0 0 rgba(50,46,29,255), 25px 24px 0 0 rgba(154,133,109,255), 1px 25px 0 0 rgba(121,98,167,255), 2px 25px 0 0 rgba(126,101,170,255), 3px 25px 0 0 rgba(121,97,164,255), 4px 25px 0 0 rgba(103,87,144,255), 5px 25px 0 0 rgba(80,72,121,255), 6px 25px 0 0 rgba(78,69,121,255), 7px 25px 0 0 rgba(95,82,138,255), 8px 25px 0 0 rgba(75,65,108,255), 9px 25px 0 0 rgba(43,46,78,255), 10px 25px 0 0 rgba(42,46,76,255), 11px 25px 0 0 rgba(41,44,70,255), 12px 25px 0 0 rgba(36,39,64,255), 13px 25px 0 0 rgba(90,75,81,255), 14px 25px 0 0 rgba(188,149,137,255), 15px 25px 0 0 rgba(210,176,161,255), 16px 25px 0 0 rgba(208,174,157,255), 17px 25px 0 0 rgba(231,195,177,255), 18px 25px 0 0 rgba(221,179,157,255), 19px 25px 0 0 rgba(212,166,141,255), 20px 25px 0 0 rgba(144,99,59,255), 21px 25px 0 0 rgba(131,86,47,255), 22px 25px 0 0 rgba(178,137,94,255), 23px 25px 0 0 rgba(122,93,72,255), 24px 25px 0 0 rgba(58,52,28,255), 25px 25px 0 0 rgba(136,119,99,255);
  transform: rotate(0);
}
